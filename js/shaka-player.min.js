 ...
 * Original file: /npm/shaka-player@4.2.1/dist/shaka-player.compiled.js
 *
...
function pa(a,b){a.prototype=ja(b.prototype);a.prototype.constructor=a;if(oa)oa(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.dh=b.prototype}function qa(){this.o=!1;this.l=null;this.h=void 0;this.g=1;this.j=this.m=0;this.u=this.i=null}function ra(a){if(a.o)throw new TypeError("Generator is already running");a.o=!0}qa.prototype.s=function(a){this.h=a};
function sa(a,b){a.i={re:b,ye:!0};a.g=a.m||a.j}qa.prototype["return"]=function(a){this.i={"return":a};this.g=this.j};function u(a,b,c){a.g=c;return{value:b}}qa.prototype.A=function(a){this.g=a};function z(a){a.g=0}function C(a,b,c){a.m=b;void 0!=c&&(a.j=c)}function ua(a){a.m=0;a.j=2}function va(a,b){a.g=b;a.m=0}function F(a){a.m=0;var b=a.i.re;a.i=null;return b}function wa(a){a.u=[a.i];a.m=0;a.j=0}
function xa(a,b){var c=a.u.splice(0)[0];(c=a.i=a.i||c)?c.ye?a.g=a.m||a.j:void 0!=c.A&&a.j<c.A?(a.g=c.A,a.i=null):a.g=a.j:a.g=b}function ya(a){this.g=new qa;this.h=a}function za(a,b){ra(a.g);var c=a.g.l;if(c)return Aa(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.g["return"]);a.g["return"](b);return Ba(a)}
...
function Ba(a){for(;a.g.g;)try{var b=a.h(a.g);if(b)return a.g.o=!1,{value:b.value,done:!1}}catch(c){a.g.h=void 0,sa(a.g,c)}a.g.o=!1;if(a.g.i){b=a.g.i;a.g.i=null;if(b.ye)throw b.re;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
...
b.prototype[Symbol.iterator]=b.prototype.values;b.prototype.forEach=function(c,d){var e=this;this.g.forEach(function(f){return c.call(d,f,f,e)})};return b});function Ka(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var f=a[e];if(b.call(c,f,e,a))return{we:e,v:f}}return{we:-1,v:void 0}}fa("Array.prototype.findIndex",function(a){return a?a:function(b,c){return Ka(this,b,c).we}});fa("Object.is",function(a){return a?a:function(b,c){return b===c?0!==b||1/b===1/c:b!==b&&c!==c}});
...
var Mb=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$");/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
function Nb(a){var b;a instanceof Nb?(Ob(this,a.Ea),this.nb=a.nb,this.Fa=a.Fa,Pb(this,a.Ib),this.ta=a.ta,Qb(this,a.g.clone()),this.eb=a.eb):a&&(b=String(a).match(Mb))?(Ob(this,b[1]||"",!0),this.nb=Rb(b[2]||""),this.Fa=Rb(b[3]||"",!0),Pb(this,b[4]),this.ta=Rb(b[5]||"",!0),Qb(this,b[6]||"",!0),this.eb=Rb(b[7]||"")):this.g=new Sb(null)}r=Nb.prototype;r.Ea="";r.nb="";r.Fa="";r.Ib=null;r.ta="";r.eb="";
r.toString=function(){var a=[],b=this.Ea;b&&a.push(Ub(b,Vb,!0),":");if(b=this.Fa){a.push("//");var c=this.nb;c&&a.push(Ub(c,Vb,!0),"@");a.push(encodeURIComponent(b).replace(/%25([0-9a-fA-F]{2})/g,"%$1"));b=this.Ib;null!=b&&a.push(":",String(b))}if(b=this.ta)this.Fa&&"/"!=b.charAt(0)&&a.push("/"),a.push(Ub(b,"/"==b.charAt(0)?Wb:Xb,!0));(b=this.g.toString())&&a.push("?",b);(b=this.eb)&&a.push("#",Ub(b,Yb));return a.join("")};
r.resolve=function(a){var b=this.clone();"data"===b.Ea&&(b=new Nb);var c=!!a.Ea;c?Ob(b,a.Ea):c=!!a.nb;c?b.nb=a.nb:c=!!a.Fa;c?b.Fa=a.Fa:c=null!=a.Ib;var d=a.ta;if(c)Pb(b,a.Ib);else if(c=!!a.ta){if("/"!=d.charAt(0))if(this.Fa&&!this.ta)d="/"+d;else{var e=b.ta.lastIndexOf("/");-1!=e&&(d=b.ta.substr(0,e+1)+d)}if(".."==d||"."==d)d="";else if(-1!=d.indexOf("./")||-1!=d.indexOf("/.")){e=0==d.lastIndexOf("/",0);d=d.split("/");for(var f=[],g=0;g<d.length;){var h=d[g++];"."==h?e&&g==d.length&&f.push(""):".."==
h?((1<f.length||1==f.length&&""!=f[0])&&f.pop(),e&&g==d.length&&f.push("")):(f.push(h),e=!0)}d=f.join("/")}}c?b.ta=d:c=""!==a.g.toString();c?Qb(b,a.g.clone()):c=!!a.eb;c&&(b.eb=a.eb);return b};r.clone=function(){return new Nb(this)};function Ob(a,b,c){a.Ea=c?Rb(b,!0):b;a.Ea&&(a.Ea=a.Ea.replace(/:$/,""))}function Pb(a,b){if(b){b=Number(b);if(isNaN(b)||0>b)throw Error("Bad port number "+b);a.Ib=b}else a.Ib=null}function Qb(a,b,c){b instanceof Sb?a.g=b:(c||(b=Ub(b,Zb)),a.g=new Sb(b))}
...
1920<e.width||e.height&&1080<e.height)&&e.codecs.includes("avc1."))return Za(Wd(d)),!1;(e=d.decodingInfos.some(function(h){return h.supported}))||Za(Wd(d));return e});z(c)})}
...
function Sd(a){var b,c,d,e,f,g,h,k;return K(function(l){switch(l.g){case 1:b=[],c=t(a.imageStreams),d=c.next();case 2:if(d.done){l.A(4);break}e=d.value;f=e.mimeType;if(Zd.has(f)){l.A(5);break}g=$d.get(f);if(!g){Zd.set(f,!1);l.A(5);break}return u(l,ae(g),7);case 7:h=l.h,Zd.set(f,h);case 5:(k=Zd.get(f))&&b.push(e);d=c.next();l.A(2);break;case 4:a.imageStreams=b,z(l)}})}
...
var fe=0,Gd="smooth",Hd="powerEfficient",Jd="bandwidth",Zd=(new Map).set("image/svg+xml",!0).set("image/png",!0).set("image/jpeg",!0).set("image/jpg",!0),$d=(new Map).set("image/webp","data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA").set("image/avif","data:image/avif;base64,");function oe(){var a=this;this.l=null;this.o=!1;this.i=new Sa;navigator.connection&&navigator.connection.addEventListener("change",function(){if(a.g.useNetworkInformation&&a.o){a.i=new Sa;a.g&&a.i.configure(a.g.advanced);var b=a.chooseVariant();b&&a.l(b)}});this.m=[];this.u=1;this.B=!1;this.h=this.j=this.g=this.s=null;this.D=new O(function(){if(a.g.restrictToElementSize){var b=a.chooseVariant();b&&a.l(b)}})}r=oe.prototype;
...
function Tf(a){var b,c,d,e,f;return K(function(g){switch(g.g){case 1:if(!a.s||!a.g)return g["return"]();if(!a.g.serverCertificateUri||a.g.serverCertificate&&a.g.serverCertificate.length){g.A(2);break}b=ef([a.g.serverCertificateUri],a.h.retryParameters);C(g,3);c=a.D.jb.request(5,b);return u(g,c.promise,5);case 5:d=g.h;a.g.serverCertificate=Fb(d.data);va(g,4);break;case 3:throw e=F(g),new N(2,6,6017,e);case 4:if(a.j.g)return g["return"]();case 2:if(!a.g.serverCertificate||!a.g.serverCertificate.length)return g["return"]();
...
function Vf(a,b){var c,d,e,f,g;return K(function(h){switch(h.g){case 1:try{c=a.s.createSession("persistent-license")}catch(k){return d=new N(2,6,6005,k.message),a.m(d),h["return"](Promise.reject(d))}a.o.C(c,"message",function(k){a.l&&a.h.delayLicenseRequestUntilPlayed&&a.l.paused&&!a.O?a.L.push(k):Rf(a,k)});a.o.C(c,"keystatuseschange",function(k){return bg(a,k)});e={initData:null,initDataType:null,loaded:!1,Od:Infinity,Ja:null,type:"persistent-license"};a.i.set(c,e);C(h,2);return u(h,c.load(b),4);
...
Xf(a.g.keySystem)&&dg(g),h=Date.now(),C(x,2),l=a.D.jb.request(2,g),u(x,l.promise,4);case 4:k=x.h;va(x,3);break;case 2:return m=F(x),n=new N(2,6,6007,m),a.m(n),d&&d.Ja&&d.Ja.reject(n),x["return"]();case 3:if(a.j.g)return x["return"]();a.I+=(Date.now()-h)/1E3;a.h.logLicenseExchange&&Mc(k.data);C(x,5);return u(x,c.update(k.data),7);case 7:va(x,6);break;case 5:return p=F(x),q=new N(2,6,6008,p.message),a.m(q),d&&d.Ja&&d.Ja.reject(q),x["return"]();case 6:if(a.j.g)return x["return"]();v=new R("drmsessionupdate");
a.D.onEvent(v);d&&(d.Ja&&d.Ja.resolve(),y=new O(function(){d.loaded=!0;cg(a)&&a.u.resolve()}),y.R(eg));z(x)}})}
function dg(a){var b=Cc(a.body,!0,!0);if(b.includes("PlayReadyKeyMessage")){b=(new DOMParser).parseFromString(b,"application/xml");for(var c=t(b.getElementsByTagName("HttpHeader")),d=c.next();!d.done;d=c.next())d=d.value,a.headers[d.getElementsByTagName("name")[0].textContent]=d.getElementsByTagName("value")[0].textContent;a.body=Nc(b.getElementsByTagName("Challenge")[0].textContent)}else a.headers["Content-Type"]="text/xml; charset=utf-8"}
function bg(a,b){var c=b.target,d=a.i.get(c),e=!1;c.keyStatuses.forEach(function(g,h){if("string"==typeof h){var k=h;h=g;g=k}if(Xf(a.g.keySystem)&&16==h.byteLength&&(navigator.userAgent.match(/Edge?\//)||wc())){k=Ib(h);var l=k.getUint32(0,!0),m=k.getUint16(4,!0),n=k.getUint16(6,!0);k.setUint32(0,l,!1);k.setUint16(4,m,!1);k.setUint16(6,n,!1)}"status-pending"!=g&&(d.loaded=!0);"expired"==g&&(e=!0);k=Pc(h);a.ia.set(k,g)});var f=c.expiration-Date.now();(0>f||e&&1E3>f)&&d&&!d.Ja&&(a.i["delete"](c),c.close()["catch"](function(){}));
...
p;return K(function(q){switch(q.g){case 1:C(q,2);if("org.w3.clearkey"===l&&xc())throw Error("Unsupported keySystem");return u(q,navigator.requestMediaKeySystemAccess(l,e),4);case 4:return m=q.h,p=(n=m.getConfiguration().sessionTypes)?n.includes("persistent-license"):!1,sc("Tizen 3")&&(p=!1),f.set(l,{persistentState:p}),u(q,m.createMediaKeys(),5);case 5:va(q,0);break;case 2:F(q),f.set(l,null),z(q)}})},h=a.map(function(l){return g(l)}),u(k,Promise.all(h),2)):k["return"](wf(f))})}
...
function Ph(a,b){var c=a.h.parse(b);c=t(c);for(var d=c.next();!d.done;d=c.next()){var e=d.value,f=Fb(e.Rf);if(0<f.length&&(d=a.g,e=e.pts,f=new rg(f,0),181===f.Ra()&&49===f.Rd()&&1195456820===f.N()&&3===f.Ra())){var g=f.Ra();if(0!==(g&64)){g&=31;f.skip(1);for(var h=0;h<g;h++){var k=f.Ra(),l=(k&4)>>2,m=f.Ra(),n=f.Ra();l&&(k&=3,0===k||1===k?d.h.push({pts:e,type:k,xa:m,Ma:n,order:d.h.length}):(d.g.push({pts:e,type:k,value:m,order:d.g.length}),d.g.push({pts:e,type:2,value:n,order:d.g.length})))}}}}return Fh(a.g)}
...
function qi(a,b){var c=ji(a,"video")||0;gd(a.g,b,c)}function ri(a){a.g&&gd(a.g,"",0)}r.remove=function(a,b,c){var d=this,e;return K(function(f){e=kc;return a==e.X?u(f,d.g.remove(b,c),0):u(f,oi(d,a,function(){return pi(d,a,b,c)}),0)})};function si(a,b){var c;return K(function(d){c=kc;return b==c.X?a.g?u(d,a.g.remove(0,Infinity),0):d["return"]():u(d,oi(a,b,function(){return pi(a,b,0,a.l.duration)}),0)})}
r.flush=function(a){var b=this,c;return K(function(d){c=kc;return a==c.X?d["return"]():u(d,oi(b,a,function(){b.j.currentTime-=.001;fi(b,a)}),0)})};
function ti(a,b,c,d,e,f){var g;return K(function(h){g=kc;return b==g.X?(f||(a.g.s=c),fd(a.g,d,e),h["return"]()):u(h,Promise.all([oi(a,b,function(){var k=a.h[b].appendWindowStart,l=a.h[b].appendWindowEnd;a.h[b].abort();a.h[b].appendWindowStart=k;a.h[b].appendWindowEnd=l;fi(a,b)}),f?Promise.resolve():oi(a,b,function(){var k=c;0>k&&(k+=.001);a.h[b].timestampOffset=k;fi(a,b)}),oi(a,b,function(){a.h[b].appendWindowStart=0;a.h[b].appendWindowEnd=e;a.h[b].appendWindowStart=d;fi(a,b)})]),0)})}
r.endOfStream=function(a){var b=this;return K(function(c){return u(c,ui(b,function(){gi(b)||(a?b.l.endOfStream(a):b.l.endOfStream())}),0)})};r.Ia=function(a){var b=this;return K(function(c){return u(c,ui(b,function(){b.l.duration=a}),0)})};r.getDuration=function(){return this.l.duration};function pi(a,b,c,d){d<=c?fi(a,b):a.h[b].remove(c,d)}function fi(a,b){var c=a.i[b][0];c&&(c.p.resolve(),vi(a,b))}
function oi(a,b,c){nf(a.D);c={start:c,p:new lc};a.i[b].push(c);1==a.i[b].length&&wi(a,b);return c.p}
...
r.V=function(){return Infinity==this.i&&!this.s};r.ib=function(){return Infinity!=this.i&&!this.s};r.Pa=function(){return Math.max(this.u,this.fb()-this.m)};r.Me=function(a){this.u=a};r.fb=function(){return this.V()||this.ib()?Math.min(Math.max(0,(Date.now()+this.o)/1E3-this.g-this.l)+this.D,this.i):this.h?Math.min(this.h,this.i):this.i};r.hc=function(a){var b=Math.max(this.j,this.u);return Infinity==this.m?Math.ceil(1E3*b)/1E3:Math.max(b,Math.min(this.fb()-this.m+a,this.Oa()))};r.Bb=function(){return this.hc(0)};
r.Oa=function(){return Math.max(0,this.fb()-(this.V()||this.ib()?this.Zc:0))};r.Pe=function(){return null==this.l||null!=this.h&&this.B?!1:!0};r.Ke=function(a){this.D=a};M("shaka.media.PresentationTimeline",T);T.prototype.setAvailabilityTimeOffset=T.prototype.Ke;T.prototype.usingPresentationStartTime=T.prototype.Pe;T.prototype.getSeekRangeEnd=T.prototype.Oa;T.prototype.getSeekRangeStart=T.prototype.Bb;T.prototype.getSafeSeekRangeStart=T.prototype.hc;T.prototype.getSegmentAvailabilityEnd=T.prototype.fb;
T.prototype.setUserSeekStart=T.prototype.Me;T.prototype.getSegmentAvailabilityStart=T.prototype.Pa;T.prototype.isInProgress=T.prototype.ib;T.prototype.isLive=T.prototype.V;T.prototype.offset=T.prototype.offset;T.prototype.notifyMaxSegmentDuration=T.prototype.Ld;T.prototype.notifyMinSegmentStartTime=T.prototype.Md;T.prototype.lockStartTime=T.prototype.Fd;T.prototype.notifySegments=T.prototype.Gb;T.prototype.getDelay=T.prototype.lf;T.prototype.setDelay=T.prototype.gg;
T.prototype.setSegmentAvailabilityDuration=T.prototype.ce;T.prototype.setStatic=T.prototype.vc;T.prototype.setClockOffset=T.prototype.Le;T.prototype.getPresentationStartTime=T.prototype.zf;T.prototype.setDuration=T.prototype.Ia;T.prototype.getMaxSegmentDuration=T.prototype.uf;T.prototype.getDuration=T.prototype.getDuration;function yi(a,b,c){this.l=c;this.j=a;this.s=zi(a);this.g=a.g.currentTime;this.m=Date.now()/1E3;this.h=!1;this.o=0;this.u=b;this.i=function(){}}yi.prototype.release=function(){this.l=this.j=null;this.i=function(){}};function Ai(a,b){a.i=b}function Bi(a){this.g=a}function zi(a){if(a.g.paused||0==a.g.playbackRate||0==a.g.buffered.length)var b=!1;else a:{b=a.g.currentTime;a=t(Zh(a.g.buffered));for(var c=a.next();!c.done;c=a.next())if(c=c.value,!(b<c.start-.1||b>c.end-.5)){b=!0;break a}b=!1}return b};function Ci(a,b,c,d,e){var f=this;this.o=e;this.g=a;this.s=b;this.D=c;this.i=new of;this.m=!1;this.B=a.readyState;this.u=0;this.h=d;this.l=!1;this.i.C(a,"waiting",function(){return Di(f)});this.j=(new O(function(){Di(f)})).Ca(.25)}Ci.prototype.release=function(){this.i&&(this.i.release(),this.i=null);null!=this.j&&(this.j.stop(),this.j=null);this.h&&(this.h.release(),this.h=null);this.g=this.s=this.o=null};Ci.prototype.Pd=function(){this.l=!0;Di(this)};
...
function Ri(a,b){null==b?b=Infinity>a.g.getDuration()?a.g.Bb():a.g.Oa():0>b&&(b=a.g.Oa()+b);return Ti(a,Si(a,b))}r.Be=function(){this.j.Pd()};function Ti(a,b){var c=a.g.getDuration();return b>=c?c-a.l.durationBackoff:b}function Qi(a,b){var c=Math.max(a.B,a.l.rebufferingGoal),d=a.l.safeSeekOffset,e=a.g.Bb(),f=a.g.Oa(),g=a.g.getDuration();3>f-e&&(e=f-3);var h=a.g.hc(c),k=a.g.hc(d);c=a.g.hc(c+d);return b>=g?Ti(a,b):b>f?f:b<e?Xh(a.i.buffered,k)?k:c:b>=h||Xh(a.i.buffered,b)?b:c}
function Si(a,b){var c=a.g.Bb();if(b<c)return c;c=a.g.Oa();return b>c?c:b}function Pi(a,b,c){if(!b.stallEnabled)return null;var d=b.stallSkip;b=new yi(new Bi(a),b.stallThreshold,c);Ai(b,function(){d?a.currentTime+=d:(a.pause(),a.play())});return b};function Ui(a){this.J=a;this.g=null;this.h=0;this.i=!1}r=Ui.prototype;r.release=function(){this.i||(this.J=[],this.g&&this.g.stop(),this.g=null)};r.Mf=function(){this.i=!0};r.find=function(a){for(var b=this.J.length-1,c=b;0<=c;--c){var d=this.J[c],e=c<b?this.J[c+1].startTime:d.endTime;if(a>=d.startTime&&a<e)return c+this.h}return this.J.length&&a<this.J[0].startTime?this.h:null};r.get=function(a){if(0==this.J.length)return null;a-=this.h;return 0>a||a>=this.J.length?null:this.J[a]};
r.offset=function(a){if(!this.i)for(var b=t(this.J),c=b.next();!c.done;c=b.next()){c=c.value;c.startTime+=a;c.endTime+=a;c.j+=a;c=t(c.h);for(var d=c.next();!d.done;d=c.next())d=d.value,d.startTime+=a,d.endTime+=a,d.j+=a}};r.mc=function(a){!this.i&&a.length&&(this.J=this.J.filter(function(b){return b.startTime<a[0].startTime}),this.J.push.apply(this.J,ia(a)))};r.Fb=function(a,b){var c=this;a=a.filter(function(d){return d.endTime>b&&(0==c.J.length||d.endTime>c.J[0].startTime)});this.mc(a);this.cb(b)};
r.cb=function(a){if(!this.i){var b=this.J.length;this.J=this.J.filter(function(c){return c.endTime>a});this.h+=b-this.J.length}};
...
function Wi(a,b,c){return new Ui([new Sh(a,a+b,function(){return c},0,null,null,a,a,a+b)])}M("shaka.media.SegmentIndex",Ui);Ui.forSingleSegment=Wi;Ui.prototype.getIteratorForTime=Ui.prototype.Ab;Ui.prototype.updateEvery=Ui.prototype.ad;Ui.prototype.fit=Ui.prototype.Xa;Ui.prototype.evict=Ui.prototype.cb;Ui.prototype.mergeAndEvict=Ui.prototype.Fb;Ui.prototype.offset=Ui.prototype.offset;Ui.prototype.get=Ui.prototype.get;Ui.prototype.find=Ui.prototype.find;Ui.prototype.markImmutable=Ui.prototype.Mf;
...
function rj(a,b){var c,d,e,f,g,h;K(function(k){switch(k.g){case 1:return c=kc,C(k,2),u(k,si(a.g.P,c.X),4);case 4:va(k,3);break;case 2:if(d=F(k),a.g)a.g.onError(d);case 3:e=Xc(b.mimeType,b.codecs);ei(a.g.P,e,a.m.sequenceMode);f=a.g.P.m;if(g=f.isTextVisible()||a.j.alwaysStreamText)h=sj(b),a.i.set(c.X,h),tj(a,h,0);z(k)}})}function uj(a){var b=a.i.get(jc);b&&(oj(b),pj(b)["catch"](function(){}),a.i["delete"](jc));a.o=null}
function vj(a,b){var c=a.i.get("video");if(c){var d=c.stream;if(d)if(b){var e=d.trickModeVideo;e&&!c.mb&&(wj(a,e,!1,0,!1),c.mb=d)}else if(d=c.mb)c.mb=null,wj(a,d,!0,0,!1)}}function xj(a,b,c,d,e){c=void 0===c?!1:c;d=void 0===d?0:d;e=void 0===e?!1:e;a.l=b;a.B&&(b.video&&wj(a,b.video,c,d,e),b.audio&&wj(a,b.audio,c,d,e))}function yj(a,b){a.o=b;a.B&&wj(a,b,!0,0,!1)}
function wj(a,b,c,d,e){var f=a.i.get(b.type);f||b.type!=jc?f&&(f.mb&&(b.trickModeVideo?(f.mb=b,b=b.trickModeVideo):f.mb=null),f.stream!=b||e)&&(b.type==jc&&ei(a.g.P,Xc(b.mimeType,b.codecs),a.m.sequenceMode),f.stream.closeSegmentIndex&&f.stream.closeSegmentIndex(),f.stream=b,f.ba=null,c&&(f.ac?f.dd=!0:f.Ha?(f.ob=!0,f.Gc=d,f.dd=!0):(oj(f),zj(a,f,!0,d)["catch"](function(g){if(a.g)a.g.onError(g)}))),Aj(a,f)["catch"](function(g){if(a.g)a.g.onError(g)})):rj(a,b)}
...
mj.prototype.sc=function(){for(var a=this.g.Oc(),b=t(this.i.keys()),c=b.next();!c.done;c=b.next()){var d=c.value;c=this.i.get(d);c.ba=null;var e=this.g.P;d==jc?(e=e.g,e=null==e.g||null==e.h?!1:a>=e.g&&a<e.h):(e=ii(e,d),e=Xh(e,a));if(!e){(null!=ji(this.g.P,d)||c.Ha)&&Bj(this,c);c.sa&&(c.sa.abort(),c.sa=null);if(d===jc)for(d=this.g.P.B.g,d.l=0,d.h=[],d.g=[],e=d.i,e.i=[],e.h=[],e.g=0,Eh(d),d=t(d.j.values()),e=d.next();!e.done;e=d.next())zh(e.value);c.sc=!0}}};
function Bj(a,b){b.ac||b.ob||(b.Ha?(b.ob=!0,b.Gc=0):null==hi(a.g.P,b.type)?null==b.Ka&&tj(a,b,0):(oj(b),zj(a,b,!1,0)["catch"](function(c){if(a.g)a.g.onError(c)})))}
function qj(a){var b,c,d,e,f,g,h,k,l,m;return K(function(n){if(1==n.g){b=kc;if(!a.l)throw new N(2,5,5006);c=new Map;d=new Set;a.l.audio&&(c.set(b.bb,a.l.audio),d.add(a.l.audio));a.l.video&&(c.set(b.va,a.l.video),d.add(a.l.video));a.o&&(c.set(b.X,a.o),d.add(a.o));e=a.g.P;f=a.j.forceTransmuxTS;return u(n,e.init(c,f,a.m.sequenceMode),2)}nf(a.h);var p=a.m.presentationTimeline.getDuration();Infinity>p?a.g.P.Ia(p):a.g.P.Ia(Math.pow(2,32));g=t(c.keys());for(h=g.next();!h.done;h=g.next())k=h.value,l=c.get(k),
a.i.has(k)||(m=sj(l),a.i.set(k,m),tj(a,m,0));z(n)})}function sj(a){return{stream:a,type:a.type,ba:null,za:null,Tc:null,Ed:null,Dd:null,Cd:null,mb:null,endOfStream:!1,Ha:!1,Ka:null,ob:!1,Gc:0,dd:!1,ac:!1,sc:!0,Td:!1,jc:!1,sa:null}}
function Cj(a,b){var c,d,e,f,g;return K(function(h){switch(h.g){case 1:nf(a.h);if(b.Ha||null==b.Ka||b.ac)return h["return"]();b.Ka=null;if(!b.ob){h.A(2);break}return u(h,zj(a,b,b.dd,b.Gc),3);case 3:return h["return"]();case 2:if(b.stream.segmentIndex){h.A(4);break}c=b.stream;return u(h,b.stream.createSegmentIndex(),5);case 5:if(c!=b.stream)return c.closeSegmentIndex&&c.closeSegmentIndex(),null==b.Ka&&tj(a,b,0),h["return"]();case 4:C(h,6);d=Dj(a,b);null!=d&&(tj(a,b,d),b.jc=!1);va(h,7);break;case 6:return e=
F(h),u(h,Ej(a,e),8);case 8:return h["return"]();case 7:f=Array.from(a.i.values());if(!a.B||!f.every(function(k){return k.endOfStream})){h.A(0);break}return u(h,a.g.P.endOfStream(),10);case 10:nf(a.h),g=a.g.P.getDuration(),0!=g&&g<a.m.presentationTimeline.getDuration()&&a.m.presentationTimeline.Ia(g),z(h)}})}
function Dj(a,b){if(Fj(b))return qi(a.g.P,b.stream.originalId||""),null;b.type==jc&&ri(a.g.P);var c=a.g.Oc(),d=b.za?b.za.endTime:c,e=ki(a.g.P,b.type,c),f=Math.max(a.m.minBufferTime||0,a.j.rebufferingGoal,a.j.bufferingGoal)*a.u;if(1E-6>a.m.presentationTimeline.getDuration()-d)return b.endOfStream=!0,"video"==b.type&&(c=a.i.get(jc))&&Fj(c)&&(c.endOfStream=!0),null;b.endOfStream=!1;if(e>=f)return a.j.updateIntervalSeconds/2;e=ji(a.g.P,b.type);e=Gj(a,b,c,e);if(!e)return a.j.updateIntervalSeconds;f=Infinity;
...
function Hj(a,b,c,d){var e,f,g,h,k,l,m,n,p,q,v,y;return K(function(x){switch(x.g){case 1:e=kc;f=b.stream;g=b.ba;b.Ha=!0;C(x,2);if(2==d.Cb())throw new N(1,1,1011);return u(x,Ij(a,b,d),4);case 4:nf(a.h);if(a.s)return x["return"]();h="video/mp4"==f.mimeType||"audio/mp4"==f.mimeType;k=window.ReadableStream;if(a.j.lowLatencyMode&&k&&h&&!d.l)return n=new Uint8Array(0),p=function(w){var D,B,A;return K(function(G){nf(a.h);if(a.s)return G["return"]();n=Jj(n,w);D=!1;B=0;(new ug).box("mdat",function(E){B=E.size+
E.start;D=!0}).parse(n,!1,!0);if(!D)return G.A(0);A=n.subarray(0,B);n=n.subarray(B);return u(G,Kj(a,b,c,f,d,A),0)})},u(x,Lj(a,b,d,p),6);l=Lj(a,b,d);return u(x,l,7);case 7:m=x.h;nf(a.h);if(a.s)return x["return"]();if(!d.l){x.A(8);break}return u(x,Mj(m,d,g),9);case 9:m=x.h;case 8:return nf(a.h),b.ob?(b.Ha=!1,tj(a,b,0),x["return"]()):u(x,Kj(a,b,c,f,d,m),6);case 6:nf(a.h);if(a.s)return x["return"]();b.za=d;g.next();b.Ha=!1;b.Td=!1;q=a.g.P.Na();v=q[b.type];$a(JSON.stringify(v));b.ob||a.g.Pd();tj(a,b,0);
va(x,0);break;case 2:y=F(x);nf(a.h,y);if(a.s)return x["return"]();b.Ha=!1;if(7001==y.code)b.Ha=!1,b.Ka=null,tj(a,b,0),x.A(0);else if(b.type==e.X&&a.j.ignoreTextStreamFailures)a.i["delete"](e.X),x.A(0);else if(3017==y.code)Nj(a,b,y),x.A(0);else if(1001==y.code&&y.data&&404==y.data[1])b.Ha=!1,b.Ka=null,tj(a,b,1),x.A(0);else return b.jc=!0,y.severity=2,u(x,Ej(a,y),0)}})}
...
n=l.reader.pc(),p=l.reader.pc();l=l.reader.Za(l.reader.S.byteLength-l.reader.$());if(m&&m.includes(n)||a.j.dispatchAllEmsgBoxes)"urn:mpeg:dash:event:2012"==n?a.g.Qf():(m=(new Map).set("detail",{startTime:w,endTime:w+y/q,schemeIdUri:n,value:p,timescale:q,presentationTimeDelta:v,eventDuration:y,id:x,messageData:l}),m=new R("emsg",m),a.g.onEvent(m))}).parse(f),u(k,Oj(a,b,c),2);if(3!=k.g)return nf(a.h),h=b.sc,b.sc=!1,u(k,li(a.g.P,b.type,f,e,g,h),3);nf(a.h);z(k)})}
function Oj(a,b,c){var d,e,f,g;return K(function(h){if(1==h.g){d=Math.max(a.j.bufferBehind,a.m.presentationTimeline.g);e=hi(a.g.P,b.type);if(null==e)return h["return"]();f=c-e;g=f-d;return.01>=g?h["return"]():u(h,a.g.P.remove(b.type,e,e+g),2)}nf(a.h);z(h)})}function Fj(a){return a&&a.type==jc&&("application/cea-608"==a.stream.mimeType||"application/cea-708"==a.stream.mimeType)}
function Lj(a,b,c,d){var e,f,g,h,k;return K(function(l){if(1==l.g)return e=lf,f=lj(c.ya(),c.Ba,c.la,a.j.retryParameters,d),g=b.stream,a.g.modifySegmentRequest(f,{type:g.type,init:c instanceof Qh,duration:c.endTime-c.startTime,mimeType:g.mimeType,codecs:g.codecs,bandwidth:g.bandwidth}),h=a.g.jb.request(e,f),b.sa=h,u(l,h.promise,2);k=l.h;b.sa=null;return l["return"](k.data)})}
function zj(a,b,c,d){var e,f;return K(function(g){if(1==g.g)return b.ob=!1,b.dd=!1,b.Gc=0,b.ac=!0,b.za=null,b.Tc=null,b.ba=null,d?(e=a.g.Oc(),f=a.g.P.getDuration(),u(g,a.g.P.remove(b.type,e+d,f),3)):u(g,si(a.g.P,b.type),4);if(3!=g.g)return nf(a.h),c?u(g,a.g.P.flush(b.type),3):g.A(3);nf(a.h);b.ac=!1;b.endOfStream=!1;tj(a,b,0);z(g)})}
function tj(a,b,c){var d=b.type;if(d!=jc||a.i.has(d))b.Ka=(new nc(function(){var e;return K(function(f){if(1==f.g)return C(f,2),u(f,Cj(a,b),4);if(2!=f.g)return va(f,0);e=F(f);if(a.g)a.g.onError(e);z(f)})})).R(c)}function oj(a){null!=a.Ka&&(a.Ka.stop(),a.Ka=null)}function pj(a){return K(function(b){return a.sa?u(b,a.sa.abort(),0):b.A(0)})}function Ej(a,b){return K(function(c){if(1==c.g)return u(c,Me(a.D),2);nf(a.h);a.g.onError(b);b.handled||a.j.failureCallback(b);z(c)})};function Pj(a,b){var c=Qj(),d=this;this.j=b;this.i=a;this.l=c;this.o=null;this.m=[];this.h=this.g=null;this.u=Promise.resolve().then(function(){return Rj(d)});this.s=new mf(function(){return Sj(d)})}Pj.prototype.destroy=function(){return this.s.destroy()};function Sj(a){var b,c,d;return K(function(e){if(1==e.g)return a.h&&a.h.abort(),Tj(a),u(e,a.u,2);a.g&&a.g.Ga.kb();b=t(a.m);for(c=b.next();!c.done;c=b.next())d=c.value,d.Ga.kb();a.g=null;a.m=[];a.j=null;z(e)})}
function Uj(a,b){var c={Hb:function(){},Vc:function(){},kb:function(){},onError:function(){},Xc:function(){},ah:function(){}};a.m.push({create:b,Ga:c});a.h&&a.h.abort();Tj(a);return c}
function Rj(a){return K(function(b){if(a.s.g)b=b.A(0);else{if(0==a.m.length||a.g&&!a.g.gb)var c=!1;else{a.g&&(a.g.Ga.kb(),a.g=null);c=a.m.shift();var d=c.create(a.l);d?(c.Ga.Hb(),a.g={node:d.node,payload:d.payload,gb:d.gb,Ga:c.Ga}):c.Ga.Xc();c=!0}c?c=Promise.resolve():a.g?c=Vj(a):(a.j.Of(a.i),a.o=new lc,c=a.o);b=u(b,c,1)}return b})}
function Vj(a){var b,c;return K(function(d){switch(d.g){case 1:return a.i=a.j.wf(a.i,a.l,a.g.node,a.g.payload),C(d,2),a.h=a.j.ff(a.i,a.l,a.g.payload),u(d,a.h.promise,4);case 4:a.h=null;a.i==a.g.node&&(a.g.Ga.Vc(),a.g=null);va(d,0);break;case 2:b=F(d);if(7001==b.code)a.g.Ga.kb();else a.g.Ga.onError(b);a.g=null;a.h=null;c=a;return u(d,a.j.handleError(a.l,b),5);case 5:c.i=d.h,z(d)}})}function Tj(a){a.o&&(a.o.resolve(),a.o=null)};function Wj(a){this.g=null;for(var b=t(Array.from(a.textTracks)),c=b.next();!c.done;c=b.next())c=c.value,c.mode="disabled","Shaka Player TextTrack"==c.label&&(this.g=c);this.g||(this.g=a.addTextTrack("subtitles","Shaka Player TextTrack"));this.g.mode="hidden"}r=Wj.prototype;r.remove=function(a,b){if(!this.g)return!1;Xj(this.g,function(c){return c.startTime<b&&c.endTime>a});return!0};
...
l+h.payload+k}var d=b(a,[]),e=[];a=this.g.cues?Array.from(this.g.cues):[];var f={};d=t(d);for(var g=d.next();!g.done;f={rb:f.rb},g=d.next())f.rb=g.value,a.some(function(h){return function(k){return k.startTime==h.rb.startTime&&k.endTime==h.rb.endTime&&k.text==h.rb.payload?!0:!1}}(f))||(g=Yj(f.rb))&&e.push(g);a=e.slice().sort(function(h,k){return h.startTime!=k.startTime?h.startTime-k.startTime:h.endTime!=k.endTime?h.endTime-k.startTime:"line"in VTTCue.prototype?e.indexOf(k)-e.indexOf(h):e.indexOf(h)-
...
f.writingMode==c.writingMode||(f.webkitWritingMode=c.writingMode);c.size&&(c.writingMode==mb?f.width=c.size+"%":f.height=c.size+"%")}function gk(a,b,c){var d=(d=(new RegExp(/(\d*\.?\d+)([a-z]+|%+)/)).exec(a))?{value:Number(d[1]),unit:d[2]}:null;if(!d)return a;var e=d.value;switch(d.unit){case "%":return e/100*c.clientHeight/b.cellResolution.rows+"px";case "c":return c.clientHeight*e/b.cellResolution.rows+"px";default:return a}}
function hk(a,b){for(var c=a.length-1;0<=c;c--){var d=b(a[c]);if(d||0===d)return d}return null}M("shaka.text.UITextDisplayer",bk);bk.prototype.setTextVisibility=bk.prototype.setTextVisibility;bk.prototype.isTextVisible=bk.prototype.isTextVisible;bk.prototype.remove=bk.prototype.remove;bk.prototype.destroy=bk.prototype.destroy;bk.prototype.append=bk.prototype.append;function ik(a,b){function c(h){for(var k=h,l=t(b),m=l.next();!m.done;m=l.next())m=m.value,m.end&&m.start<h&&(k+=m.end-m.start);h=Math.floor(k/3600);l=Math.floor(k/60%60);m=Math.floor(k%60);k=Math.floor(1E3*k%1E3);return(10>h?"0":"")+h+":"+(10>l?"0":"")+l+":"+(10>m?"0":"")+m+"."+(100>k?10>k?"00":"0":"")+k}function d(h){var k=[],l=700<=h.fontWeight,m="italic"==h.fontStyle,n=h.textDecoration.includes("underline");l&&k.push("b");m&&k.push("i");n&&k.push("u");l=k.reduce(function(p,q){return p+"<"+q+">"},
...
function nk(a){var b=a.type;if(a.init)return Bk;if("video"==b)return a.codecs.includes(",")?qk:ok;if("audio"==b)return pk;if("text"==b)return"application/mp4"===a.mimeType?rk:Ck}function sk(a,b){var c=a.h.Na()[b];if(!c.length)return NaN;var d=a.h.getCurrentTime();return(c=c.find(function(e){return e.start<=d&&e.end>=d}))?1E3*(c.end-d):NaN}
function tk(a,b){var c=a.h.Ya();if(!c.length)return NaN;var d=c[0];c=t(c);for(var e=c.next();!e.done;e=c.next())e=e.value,"variant"===e.type&&e.bandwidth>d.bandwidth&&(d=e);switch(b){case ok:return d.videoBandwidth||NaN;case pk:return d.audioBandwidth||NaN;default:return d.bandwidth}}
...
f.preferredAudioLanguage))})};return f}function Kk(a,b,c){var d={".drm.keySystemsMapping":"",".drm.servers":"",".drm.clearKeys":"",".drm.advanced":{distinctiveIdentifierRequired:!1,persistentStateRequired:!1,videoRobustness:"",audioRobustness:"",sessionType:"",serverCertificate:new Uint8Array(0),serverCertificateUri:"",individualizationServer:""}};return Ek(a,b,c||Ik(),d,"")}
...
function Ok(a){function b(f){return{timestamp:f.timestamp,state:f.state,duration:f.duration}}for(var c=[],d=t(a.h),e=d.next();!e.done;e=d.next())c.push(b(e.value));a.g&&c.push(b(a.g));return c};function Pk(){this.i=this.h=null;this.g=[]}function Qk(a,b,c){a.i!=b&&(a.i=b,a.g.push({timestamp:Date.now()/1E3,id:b.id,type:"text",fromAdaptation:c,bandwidth:null}))};function Rk(){this.u=this.B=this.G=this.D=this.s=this.j=this.F=this.m=this.i=this.O=this.T=this.I=this.L=this.M=this.l=this.o=NaN;this.g=new Lk;this.h=new Pk};function U(a,b){We.call(this);var c=this;this.l=Sk;this.Ic=this.g=null;this.ha=!1;this.Qc=new of;this.Wb=new of;this.s=new of;this.zd=this.u=this.Vb=this.i=this.Rc=this.I=this.j=this.ia=this.T=this.Sc=this.M=this.Jc=this.G=this.vb=this.B=this.L=this.m=this.F=null;this.Ee=1E9;this.h=Tk(this);this.$b={width:Infinity,height:Infinity};this.o=null;this.La=new Ce(this.h.preferredAudioLanguage,this.h.preferredVariantRole,this.h.preferredAudioChannelCount);this.sb=this.h.preferredTextLanguage;this.Zb=this.h.preferredTextRole;
...
(new Map).set("state",e.name)));return d.get(e)(f,g)},handleError:function(e){return K(function(f){return 1==f.g?u(f,Xk(c,e),2):f["return"](e.K?c.Y:c.O)})},Of:function(e){c.dispatchEvent(fl("onstateidle",(new Map).set("state",e.name)))}});this.De=new O(function(){Nd(c.i.variants,c.h.restrictions,c.$b)&&gl(c)});a&&this.Yb(a,!0)}pa(U,We);function fl(a,b){return new R(a,b)}r=U.prototype;
r.destroy=function(){var a=this,b;return K(function(c){switch(c.g){case 1:if(a.l==hl)return c["return"]();a.l=hl;b=Uj(a.ua,function(){return{node:a.O,payload:Qj(),gb:!1}});return u(c,new Promise(function(d){b.Hb=function(){};b.Vc=function(){d()};b.kb=function(){d()};b.onError=function(){d()};b.Xc=function(){d()}}),2);case 2:return u(c,a.ua.destroy(),3);case 3:a.Qc&&(a.Qc.release(),a.Qc=null);a.Wb&&(a.Wb.release(),a.Wb=null);a.s&&(a.s.release(),a.s=null);a.zd=null;a.u=null;a.h=null;a.o=null;a.Ic=null;
a.T=null;if(!a.F){c.A(4);break}return u(c,a.F.destroy(),5);case 5:a.F=null;case 4:We.prototype.release.call(a),z(c)}})};r.Yb=function(a,b){b=void 0===b?!0:b;if(this.l==hl)return Promise.reject(il());var c=Qj();c.K=a;oc()||(b=!1);var d=b?this.ub:this.Y,e=Uj(this.ua,function(){return{node:d,payload:c,gb:!1}});e.Hb=function(){};return jl(e)};r.detach=function(){var a=this;if(this.l==hl)return Promise.reject(il());var b=Uj(this.ua,function(){return{node:a.O,payload:Qj(),gb:!1}});b.Hb=function(){};return jl(b)};
r.ge=function(a){var b=this;a=void 0===a?!0:a;if(this.l==hl)return Promise.reject(il());oc()||(a=!1);var c=Qj(),d=Uj(this.ua,function(e){var f=e.K&&a?b.ub:e.K?b.Y:b.O;c.K=e.K;return{node:f,payload:c,gb:!1}});d.Hb=function(){};return jl(d)};r.og=function(a){this.cc=a};
r.load=function(a,b,c){var d=this;this.cc=null;if(this.l==hl)return Promise.reject(il());this.dispatchEvent(fl("loading"));var e=Qj();e.uri=a;e.de=Date.now()/1E3;c&&(e.mimeType=c);void 0!==b&&(e.startTime=b);var f=kl(this,e)?this.wb:this.ca,g=Uj(this.ua,function(h){if(null==h.K)return null;e.K=h.K;return{node:f,payload:e,gb:!0}});this.o=new Rk;this.T=ll(this);g.Hb=function(){};return new Promise(function(h,k){g.Xc=function(){return k(new N(2,7,7002))};g.Vc=function(){h();d.dispatchEvent(fl("loaded"))};
g.kb=function(){return k(il())};g.onError=function(l){return k(l)}})};function kl(a,b){if(!oc())return!0;var c=b.mimeType,d=b.uri||"";c||(c=og(d),c=ml[c]);if(c){if(""==(b.K||qc()).canPlayType(c))return!1;if(!oc()||!(c in ng||og(d)in pg)||a.h.streaming.preferNativeHls)return!0;if(vc())return a.h.streaming.useNativeHlsOnSafari}return!1}function Wk(a,b,c){null==b.K&&(b.K=c.K,a.Wb.C(b.K,"error",function(){var d=nl(a);d&&ol(a,d)}));a.g=b.K;return Promise.resolve()}
function Xk(a,b){var c,d,e,f,g,h,k,l,m;return K(function(n){switch(n.g){case 1:return a.l!=hl&&(a.l=Sk),c=a.Mb.map(function(p){return p()}),a.Mb=[],u(n,Promise.all(c),2);case 2:a.dispatchEvent(fl("unloading"));b.mimeType=null;b.startTime=null;b.uri=null;b.K&&a.s.lb();a.De.stop();a.vb&&(a.vb.release(),a.vb=null);a.Jc&&(a.Jc.stop(),a.Jc=null);if(!a.I){n.A(3);break}return u(n,a.I.stop(),4);case 4:a.I=null,a.Rc=null;case 3:if(!a.u){n.A(5);break}return u(n,a.u.stop(),5);case 5:if(!a.j){n.A(7);break}return u(n,
...
t(a.i.variants);for(e=d.next();!e.done;e=d.next())for(f=e.value,g=t([f.audio,f.video]),h=g.next();!h.done;h=g.next())(k=h.value)&&k.segmentIndex&&k.segmentIndex.release();l=t(a.i.textStreams);for(h=l.next();!h.done;h=l.next())m=h.value,m.segmentIndex&&m.segmentIndex.release()}a.i=null;a.o=new Rk;a.Gd=null;pl(a);z(n)}})}
...
enableLowLatencyMode:function(){a.configure("streaming.lowLatencyMode",!0)}},f=Date.now()/1E3;return new Ne(function(){var g,h,k,l;return K(function(m){if(1==m.g)return g=a,u(m,a.I.start(c,e),2);g.i=m.h;h=fl("manifestparsed");a.dispatchEvent(h);if(0==a.i.variants.length)throw new N(2,4,4036);vl(a.i);k=Date.now()/1E3;l=k-f;a.o.F=l;z(m)})}(),function(){return a.I.stop()})}
function al(a,b){var c,d;return K(function(e){return 1==e.g?(c=Date.now()/1E3,d=!0,a.m=wl(a,{jb:a.F,onError:function(f){ol(a,f)},Wc:function(f){xl(a,f)},onExpirationUpdated:function(f,g){yl(a,f,g)},onEvent:function(f){a.dispatchEvent(f);"drmsessionupdate"==f.type&&d&&(d=!1,a.o.j=Date.now()/1E3-c)}}),a.m.configure(a.h.drm),u(e,Ff(a.m,a.i.variants,a.i.offlineSessionIds),2)):3!=e.g?u(e,a.m.Yb(b.K),3):u(e,tl(a,a.i),0)})}
function bl(a,b,c){var d,e,f,g,h,k,l,m,n,p,q,v;return K(function(y){switch(y.g){case 1:b.startTime=c.startTime;null!=a.cc&&(b.startTime=a.cc,a.cc=null);d=b.K;e=b.uri;a.Vb=e;a.G=new Yi({Pc:function(){return d.playbackRate},Lc:function(){return d.defaultPlaybackRate},be:function(x){d.playbackRate=x},Ae:function(x){d.currentTime+=x}});f=function(){return zl(a)};g=function(){return Al(a)};a.s.C(d,"playing",f);a.s.C(d,"pause",f);a.s.C(d,"ended",f);a.s.C(d,"ratechange",g);h=a.h.abrFactory;a.u&&a.zd==h||
(a.zd=h,a.u=h(),"function"!=typeof a.u.setMediaElement&&(te(),a.u.setMediaElement=function(){}),a.u.configure(a.h.abr));a.La=new Ce(a.h.preferredAudioLanguage,a.h.preferredVariantRole,a.h.preferredAudioChannelCount);a.sb=a.h.preferredTextLanguage;a.Zb=a.h.preferredTextRole;a.Xb=a.h.preferForcedSubs;Bl(a.i.presentationTimeline,a.h.playRangeStart,a.h.playRangeEnd);a.u.init(function(x,w,D){a.j&&x!=a.j.l&&Cl(a,x,!0,void 0===w?!1:w,void 0===D?0:D)});a.u.setMediaElement(d);a.B=Dl(a,b.startTime);a.vb=El(a);
k=Math.max(a.i.minBufferTime,a.h.streaming.rebufferingGoal);Fl(a,k);zd(a.i,a.h.preferredVideoCodecs,a.h.preferredAudioCodecs,a.h.preferredAudioChannelCount,a.h.preferredDecodingAttributes);a.j=Gl(a);a.j.configure(a.h.streaming);a.l=Hl;d.textTracks&&a.s.C(d.textTracks,"addtrack",function(x){if(x.track)switch(x=x.track,x.kind){case "chapters":Il(a,x)}});a.dispatchEvent(fl("streaming"));l=null;if(m=a.Ya().find(function(x){return x.active})){y.A(2);break}l=gl(a);Cl(a,l,!0,!1,0);if(!a.h.streaming.startAtSegmentBoundary){y.A(3);
break}n=a.B.Dc();return u(y,Jl(l,n),4);case 4:p=y.h,a.B.ud(p);case 3:Kl(a,null,be(l));case 2:return q=a.Db().find(function(x){return x.active}),q||((v=le(a.i.textStreams,a.sb,a.Zb,a.Xb)[0]||null)&&Qk(a.o.h,v,!0),l&&(v?(l.audio&&Ll(a,l.audio,v)&&(a.ha=!0),a.ha&&a.L.m.setTextVisibility(!0),Ml(a)):a.ha=!1),v&&(a.h.streaming.alwaysStreamText||a.yd())&&yj(a.j,v)),u(y,a.j.start(),5);case 5:a.h.abr.enabled&&(a.u.enable(),Nl(a)),Qd(a.j?a.j.l:null,a.i),Ol(a.i),Pl(a),Ql(a),a.i.variants.some(function(x){return x.primary}),
a.s.oa(d,"loadedmetadata",function(){a.o.m=Date.now()/1E3-c.de}),z(y)}})}
function cl(a,b,c){var d,e,f,g,h,k,l;return K(function(m){return 1==m.g?(d=kc,e=Date.now()/1E3,f=!0,a.m=wl(a,{jb:a.F,onError:function(n){ol(a,n)},Wc:function(n){xl(a,n)},onExpirationUpdated:function(n,p){yl(a,n,p)},onEvent:function(n){a.dispatchEvent(n);"drmsessionupdate"==n.type&&f&&(f=!1,a.o.j=Date.now()/1E3-e)}}),a.m.configure(a.h.drm),g=c.uri||"",h=og(g),k=ml[h],"application/x-mpegurl"==k&&vc()&&(k="application/vnd.apple.mpegurl"),k||(k="video/mp4"),l={id:0,language:"und",disabledUntilTime:0,
...
function dl(a,b,c){function d(){return zl(a)}b.uri=c.uri;b.startTime=c.startTime;a.Vb=b.uri;var e=b.K;a.B=new Ni(e);var f=!1;a.Mb.push(function(){f=!0});null!=b.startTime&&a.B.ud(b.startTime);a.G=new Yi({Pc:function(){return e.playbackRate},Lc:function(){return e.defaultPlaybackRate},be:function(k){e.playbackRate=k},Ae:function(k){e.currentTime+=k}});Fl(a,a.h.streaming.rebufferingGoal);a.s.C(e,"playing",d);a.s.C(e,"pause",d);a.s.C(e,"ended",d);a.s.C(e,"ratechange",function(){return Al(a)});"none"!=
e.preload&&a.s.oa(e,"loadedmetadata",function(){a.o.m=Date.now()/1E3-c.de});e.audioTracks&&(a.s.C(e.audioTracks,"addtrack",function(){return Pl(a)}),a.s.C(e.audioTracks,"removetrack",function(){return Pl(a)}),a.s.C(e.audioTracks,"change",function(){return Pl(a)}));e.textTracks&&(a.s.C(e.textTracks,"addtrack",function(k){if(k.track)switch(k=k.track,k.kind){case "metadata":Rl(a,k);break;case "chapters":Il(a,k);break;default:Pl(a)}}),a.s.C(e.textTracks,"removetrack",function(){return Pl(a)}),a.s.C(e.textTracks,
"change",function(){return Pl(a)}));var g=og(b.uri);e.src=vk(a.T,b.uri,ml[g]);(tc()||sc("Web0S"))&&e.load();a.l=Sl;a.dispatchEvent(fl("streaming"));var h=new lc;Ei(e,HTMLMediaElement.HAVE_METADATA,a.s,function(){h.resolve()});Ei(e,HTMLMediaElement.HAVE_CURRENT_DATA,a.s,function(){var k;return K(function(l){if(1==l.g)return Tl(a),k=Ul(a),k.find(function(m){return"disabled"!=m.mode})?l.A(2):u(l,new Promise(function(m){a.s.oa(e.textTracks,"change",m);(new O(m)).R(1)}),2);if(f)return l["return"]();Vl(a);
...
function Xl(a){switch(a.l){case Sl:if(a.g.ended)var b=!0;else{var c=Wh(a.g.buffered);b=null!=c&&c>=a.g.duration-1}break;case Hl:a:if(a.g.ended||gi(a.L))b=!0;else{if(a.i.presentationTimeline.V()){c=a.i.presentationTimeline.fb();var d=Wh(a.g.buffered);if(null!=d&&d>=c){b=!0;break a}}b=!1}break;default:b=!1}d=Yh(a.g.buffered,a.g.currentTime);c=a.M;var e=b,f=c.h.get(c.g);b=c.g;d=e||d>=f?He:Ie;c.g=d;b!=d&&pl(a)}function ql(a,b,c,d){return new ai(a,b,c,d)}
function ll(a){return new jk({getBandwidthEstimate:function(){return a.u?a.u.getBandwidthEstimate():NaN},Na:function(){return a.Na()},getCurrentTime:function(){return a.g?a.g.currentTime:0},Ya:function(){return a.Ya()},Nc:function(){return a.Nc()},V:function(){return a.V()}},a.h.cmcd)}
function Gl(a){return new mj(a.i,{Oc:function(){return a.B.Dc()},getBandwidthEstimate:function(){return a.u.getBandwidthEstimate()},modifySegmentRequest:function(b,c){kk(a.T,b,c)},P:a.L,jb:a.F,onError:function(b){return ol(a,b)},onEvent:function(b){return a.dispatchEvent(b)},Qf:function(){a.I&&a.I.update&&a.I.update()},Pd:function(){a.B&&a.B.Be();Xl(a)},Pf:function(b,c){var d=c.Id;d&&a.ia&&dj(a.ia,d,b)}})}
...
c);a.Gd=b;a.j&&(b=a.j,(c=b.i.get(jc))&&wj(b,c.stream,!0,0,!0))}a.u&&(a.u.configure(a.h.abr),a.h.abr.enabled?a.u.enable():a.u.disable(),Nl(a));a.M&&(b=a.h.streaming.rebufferingGoal,a.i&&(b=Math.max(b,a.i.minBufferTime)),Je(a.M,b,Math.min(.5,b/2)));a.i&&Bl(a.i.presentationTimeline,a.h.playRangeStart,a.h.playRangeEnd)}r.getConfiguration=function(){var a=Tk(this);Kk(a,this.h,Tk(this));return a};
...
r.te=function(){return this.D?this.D:null};r.V=function(){return this.i?this.i.presentationTimeline.V():this.g&&this.g.src?Infinity==this.g.duration:!1};r.ib=function(){return this.i?this.i.presentationTimeline.ib():!1};r.If=function(){if(this.i){var a=this.i.variants;return a.length?!a[0].video:!1}return this.g&&this.g.src?this.g.videoTracks?0==this.g.videoTracks.length:0==this.g.videoHeight:!1};
...
r.Ie=function(a){if(this.i&&this.j){var b=this.i.textStreams.find(function(d){return d.id==a.id});b&&b!=this.j.o&&(Qk(this.o.h,b,!1),yj(this.j,b),am(this),this.sb=b.language)}else if(this.g&&this.g.src&&this.g.textTracks){b=Ul(this);b=t(b);for(var c=b.next();!c.done;c=b.next())c=c.value,ee(c)==a.id?c.mode=this.ha?"showing":"hidden":c.mode="disabled";am(this)}};
r.Je=function(a,b,c){b=void 0===b?!1:b;c=void 0===c?0:c;if(this.i&&this.j){this.h.abr.enabled&&Va("Changing tracks while abr manager is enabled will likely result in the selected track being overriden. Consider disabling abr before calling selectVariantTrack().");var d=this.i.variants.find(function(e){return e.id==a.id});d&&je(d)&&(Cl(this,d,!1,b,c),this.La=new Be(d),Ql(this))}else if(this.g&&this.g.audioTracks)for(b=Array.from(this.g.audioTracks),b=t(b),c=b.next();!c.done;c=b.next())if(c=c.value,
ee(c)==a.id){bm(this,c);break}};r.hf=function(){return cm(this.Ya())};r.Bf=function(){return cm(this.Db())};r.gf=function(){return Array.from(dm(this.Ya()))};r.Af=function(){return Array.from(dm(this.Db()))};
r.Xd=function(a,b){if(this.i&&this.B){this.La=new Ce(a,b||"",0,"");var c=function(k,l){return k.video||l.video?k.video&&l.video?Math.abs((k.video.height||0)-(l.video.height||0))+Math.abs((k.video.width||0)-(l.video.width||0)):Infinity:0},d=this.j.l,e=this.La.create(this.i.variants),f=null;e=t(e.values());for(var g=e.next();!g.done;g=e.next())if(g=g.value,!f||c(f,d)>c(g,d))f=g;f?(c=be(f),this.Je(c,!0)):$l(this)}else if(this.g&&this.g.audioTracks){e=Array.from(this.g.audioTracks);c=Q(a);f=d=null;e=
t(e);for(g=e.next();!g.done;g=e.next()){g=g.value;var h=ie(g);Q(h.language)==c&&(d=g,b?h.roles.includes(b)&&(f=g):0==h.roles.length&&(f=g))}f?bm(this,f):d&&bm(this,d)}};
r.Yd=function(a,b,c){c=void 0===c?!1:c;if(this.i&&this.B){if(this.sb=a,this.Zb=b||"",this.Xb=c,(a=le(this.i.textStreams,this.sb,this.Zb,this.Xb)[0]||null)&&a!=this.j.o&&(Qk(this.o.h,a,!1),this.h.streaming.alwaysStreamText||this.yd()))yj(this.j,a),am(this)}else{var d=Q(a);(a=this.Db().find(function(e){return Q(e.language)==d&&(!b||e.roles.includes(b))&&e.forced==c}))&&this.Ie(a)}};
r.bg=function(a){if(this.i&&this.B){for(var b=null,c=t(this.i.variants),d=c.next();!d.done;d=c.next())if(d=d.value,d.audio.label==a){b=d;break}null!=b&&(this.La=new Ce(b.language,"",0,a),$l(this))}};r.yd=function(){var a=this.ha;return this.L?this.L.m.isTextVisible():this.g&&this.g.src&&this.g.textTracks?Ul(this).some(function(b){return"showing"==b.mode}):a};r.ue=function(){return this.g&&this.g.src&&this.g.textTracks?em(this).map(function(a){return ge(a)}):[]};
...
r.hg=function(a){a=!!a;if(this.ha!=a){this.ha=a;if(this.l==Hl)this.L.m.setTextVisibility(a),this.h.streaming.alwaysStreamText||(a?this.j.o||(a=le(this.i.textStreams,this.sb,this.Zb,this.Xb),0<a.length&&(yj(this.j,a[0]),am(this))):uj(this.j));else if(this.g&&this.g.src&&this.g.textTracks){var b=Ul(this);b=t(b);for(var c=b.next();!c.done;c=b.next())c=c.value,"disabled"!=c.mode&&(c.mode=a?"showing":"hidden")}Ml(this)}};
...
r.ve=function(){if(!this.V())return null;if(this.i)return new Date(1E3*this.i.presentationTimeline.l);if(this.g&&this.g.getStartDate){var a=this.g.getStartDate();return isNaN(a.getTime())?null:a}return null};r.Na=function(){if(this.l==Hl)return this.L.Na();var a={total:[],audio:[],video:[],text:[]};this.l==Sl&&(a.total=Zh(this.g.buffered));return a};
r.getStats=function(){if(this.l!=Hl&&this.l!=Sl)return{width:NaN,height:NaN,streamBandwidth:NaN,decodedFrames:NaN,droppedFrames:NaN,corruptedFrames:NaN,stallsDetected:NaN,gapsJumped:NaN,estimatedBandwidth:NaN,completionPercent:NaN,loadLatency:NaN,manifestTimeSeconds:NaN,drmTimeSeconds:NaN,playTime:NaN,pauseTime:NaN,bufferingTime:NaN,licenseTime:NaN,liveLatency:NaN,maxSegmentDuration:NaN,switchHistory:[],stateHistory:[]};zl(this);var a=this.g,b=a.currentTime/a.duration;if(!isNaN(b)){var c=this.o;b=
Math.round(100*b);c.i=isNaN(c.i)?b:Math.max(c.i,b)}this.B&&(this.o.O=this.B.ie(),this.o.T=this.B.je());if(a.getVideoPlaybackQuality){c=a.getVideoPlaybackQuality();b=this.o;var d=Number(c.totalVideoFrames);b.M=Number(c.droppedVideoFrames);b.L=d;this.o.I=Number(c.corruptedVideoFrames)}this.m?(c=this.m,c=c.I?c.I:NaN):c=NaN;this.o.s=c;if(this.l==Hl){if(c=this.j.l)this.o.B=(this.G?this.G.i:1)*c.bandwidth;c&&c.video&&(b=this.o,d=c.video.height||NaN,b.o=c.video.width||NaN,b.l=d);this.V()&&(c=this.ve().valueOf()+
1E3*this.rc().end,this.o.D=(Date.now()-c)/1E3);this.i&&this.i.presentationTimeline&&(this.o.G=this.i.presentationTimeline.g);c=this.u.getBandwidthEstimate();this.o.u=c}this.l==Sl&&(c=this.o,b=a.videoHeight||NaN,c.o=a.videoWidth||NaN,c.l=b);var e=this.o;a=e.o;c=e.l;b=e.B;d=e.L;var f=e.M,g=e.I,h=e.T,k=e.O,l=e.u,m=e.i,n=e.m,p=e.F,q=e.j,v=Nk(e.g,"playing"),y=Nk(e.g,"paused"),x=Nk(e.g,"buffering"),w=e.s,D=e.D,B=e.G,A=Ok(e.g),G=[];e=t(e.h.g);for(var E=e.next();!E.done;E=e.next())E=E.value,G.push({timestamp:E.timestamp,
id:E.id,type:E.type,fromAdaptation:E.fromAdaptation,bandwidth:E.bandwidth});return{width:a,height:c,streamBandwidth:b,decodedFrames:d,droppedFrames:f,corruptedFrames:g,stallsDetected:h,gapsJumped:k,estimatedBandwidth:l,completionPercent:m,loadLatency:n,manifestTimeSeconds:p,drmTimeSeconds:q,playTime:v,pauseTime:y,bufferingTime:x,licenseTime:w,liveLatency:D,maxSegmentDuration:B,stateHistory:A,switchHistory:G}};
...
emsgSchemeIdUris:null,roles:[],forced:!!g,channelsCount:null,audioSamplingRate:null,spatialAudio:!1,closedCaptions:null};w=Xc(x.mimeType,x.codecs);D=cd(w);if(!D)throw new N(2,2,2014,d);h.i.textStreams.push(x);Pl(h);return B["return"](ce(x))}})};
r.Ue=function(a,b,c){var d=this,e,f,g,h;return K(function(k){switch(k.g){case 1:if(d.l!=Hl&&d.l!=Sl)throw new N(1,7,7004);if(c){k.A(2);break}return u(k,fm(d,a),3);case 3:c=k.h;case 2:e=[];if(d.D)try{e=d.D.getServerSideCuePoints()}catch(l){}return u(k,gm(d,a,b,"chapters",c,"",e),4);case 4:f=k.h;g=d.ue();h=g.find(function(l){return l.language==b});if(!h){k.A(5);break}return u(k,new Promise(function(l,m){d.s.oa(f,"load",l);d.s.oa(f,"error",function(){m(new N(1,2,2015))})}),6);case 6:return k["return"](h);
...
segmentIndex:k,mimeType:h,codecs:"",kind:"caption",encrypted:!1,drmInfos:[],keyIds:new Set,language:e.closedCaptions.get(g),label:null,type:jc,primary:!1,trickModeVideo:null,emsgSchemeIdUris:null,roles:e.roles,forced:!1,channelsCount:null,audioSamplingRate:null,spatialAudio:!1,closedCaptions:null};b.textStreams.push(h);c.add(g)}}function tl(a,b){return K(function(c){if(1==c.g)return u(c,km(a,b),2);Zl(a,b);z(c)})}
function km(a,b){var c;return K(function(d){if(1==d.g)return c=a.j?a.j.l:null,u(d,Od(c,b),2);Ol(b);z(d)})}
function Zl(a,b){if(a.l!=hl){Nd(b.variants,a.h.restrictions,a.$b)&&a.j&&Pl(a);var c=a.m?a.m.g:null;if(c&&a.m.s)for(var d=t(b.variants),e=d.next();!e.done;e=d.next()){e=e.value;e=t((e.video?e.video.drmInfos:[]).concat(e.audio?e.audio.drmInfos:[]));for(var f=e.next();!f.done;f=e.next())if(f=f.value,f.keySystem==c.keySystem){f=t(f.initData||[]);for(var g=f.next();!g.done;g=f.next())g=g.value,Qf(a.m,g.initDataType,g.initData)}}lm(a,b)}}
...
function pl(a){var b=a.xd();if(a.o&&a.M&&a.B){var c=a.G;c.j=b;Zi(c);a.T&&(c=a.T,b||c.i||(c.i=!0),c.i&&b&&(c.l=!0),c.m=b);zl(a)}b=(new Map).set("buffering",b);a.dispatchEvent(fl("buffering",b))}function Al(a){var b=a.g.playbackRate;0!=b&&(a.G&&a.G.set(b),b=fl("ratechange"),a.dispatchEvent(b))}function zl(a){if(a.o&&a.M){var b=a.o.g;a.M.g==Ie?Mk(b,"buffering"):a.g.paused?Mk(b,"paused"):a.g.ended?Mk(b,"ended"):Mk(b,"playing")}}
function Ql(a){try{lm(a,a.i)}catch(c){return ol(a,c),!1}var b=a.i.variants.filter(function(c){return je(c)});b=a.La.create(b);a.u.setVariants(Array.from(b.values()));return!0}function gl(a){return Ql(a)?a.u.chooseVariant():null}function $l(a){var b=gl(a);b&&Cl(a,b,!0,!0,0)}
function Cl(a,b,c,d,e){var f=a.j.l;if(b==f)d&&xj(a.j,b,d,e,!0);else{var g=a.o.h;g.h!=b&&(g.h=b,g.g.push({timestamp:Date.now()/1E3,id:b.id,type:"variant",fromAdaptation:c,bandwidth:b.bandwidth}));xj(a.j,b,d,e);d=null;f&&(d=be(f));b=be(b);c?Kl(a,d,b):mm(a,d,b)}}function bm(a,b){var c=Array.from(a.g.audioTracks).find(function(e){return e.enabled});b.enabled=!0;b.id!==c.id&&(c.enabled=!1);c=ie(c);var d=ie(b);mm(a,c,d)}
...
function om(a,b){if(1002!=b.code&&1011!=b.code||1!=b.category||!navigator.onLine)return!1;var c=a.h.streaming.maxDisabledTime;if(0==c)if(1011==b.code)c=1;else return!1;for(var d=a.Ya().find(function(h){return h.active}),e=a.i,f=t(e.variants),g=f.next();!g.done;g=f.next())g=g.value,g.id===d.id&&(g.disabledUntilTime=Date.now()/1E3+c);Nd(e.variants,a.h.restrictions,a.$b);d=gl(a);if(!d)return!1;e=a.Na().video.reduce(function(h,k){return h+k.end-k.start},0);Cl(a,d,!1,!0,e);a.De.R(c);return!0}
...
(e=!0)}}}if(!e||Ql(a))(d=a.j.l)&&!d.allowedByKeySystem&&$l(a),e&&Pl(a)}}function yl(a,b,c){if(a.I&&a.I.onExpirationUpdated)a.I.onExpirationUpdated(b,c);b=fl("expirationupdated");a.dispatchEvent(b)}function Bl(a,b,c){0<b&&(a.V()||a.Me(b));b=a.getDuration();c<b&&(a.V()||a.Ia(c))}
...
missingKeys:Array.from(g),restrictedKeyStatuses:Array.from(h)},new N(2,4,4012,c);}function Ol(a){if(!a.variants.some(je))throw new N(2,4,4032);}function nm(a,b){K(function(c){if(1==c.g)return u(c,Promise.resolve(),2);a.l!=hl&&a.dispatchEvent(b);z(c)})}function dm(a){var b=new Set;a=t(a);for(var c=a.next();!c.done;c=a.next())c=c.value,c.language?b.add(Q(c.language)):b.add("und");return b}
...
h.push({language:l,role:n,label:p})}});return h}function il(){return new N(2,7,7E3)}function el(a,b,c,d,e,f){return d==a&&e.K==f.K&&e.uri==f.uri&&e.mimeType==f.mimeType?b:c}function Qj(){return{K:null,mimeType:null,startTime:null,de:NaN,uri:null}}function jl(a){return new Promise(function(b,c){a.kb=function(){return c(il())};a.Vc=function(){return b()};a.onError=function(d){return c(d)};a.Xc=function(){return c(il())}})}M("shaka.Player",U);U.prototype.setVideoContainer=U.prototype.Ne;
U.prototype.getManifestParserFactory=U.prototype.tf;U.prototype.getManifest=U.prototype.rf;U.prototype.retryStreaming=U.prototype.Ud;U.prototype.setMaxHardwareResolution=U.prototype.ae;U.prototype.addChaptersTrack=U.prototype.Ue;U.prototype.addTextTrackAsync=U.prototype.Ve;U.prototype.getStats=U.prototype.getStats;U.prototype.getBufferedInfo=U.prototype.Na;U.prototype.getPresentationStartTimeAsDate=U.prototype.ve;U.prototype.getPlayheadTimeAsDate=U.prototype.yf;
...
U.prototype.getExpiration=U.prototype.ec;U.prototype.drmInfo=U.prototype.drmInfo;U.prototype.keySystem=U.prototype.keySystem;U.prototype.goToLive=U.prototype.Gf;U.prototype.seekRange=U.prototype.rc;U.prototype.isAudioOnly=U.prototype.If;U.prototype.isInProgress=U.prototype.ib;U.prototype.isLive=U.prototype.V;U.prototype.getAdManager=U.prototype.te;U.prototype.getAssetUri=U.prototype.wd;U.prototype.getNetworkingEngine=U.prototype.fc;U.prototype.getMediaElement=U.prototype.vf;
...
U.probeSupport=function(a){a=void 0===a?!0:a;var b,c,d,e,f,g;return K(function(h){if(1==h.g)return b={},a?u(h,gg(),3):h.A(2);2!=h.g&&(b=h.h);var k={};if(oc()){for(var l in ng)k[l]=!0;for(var m in pg)k[m]=!0}l={mpd:"application/dash+xml",m3u8:"application/x-mpegurl",ism:"application/vnd.ms-sstr+xml"};m=t(["application/dash+xml","application/x-mpegurl","application/vnd.apple.mpegurl","application/vnd.ms-sstr+xml"]);for(var n=m.next();!n.done;n=m.next())n=n.value,k[n]=oc()?!!ng[n]:pc(n);for(var p in l)k[p]=
oc()?!!pg[p]:pc(l[p]);c=k;p='video/mp4; codecs="avc1.42E01E",video/mp4; codecs="avc3.42E01E",video/mp4; codecs="hev1.1.6.L93.90",video/mp4; codecs="hvc1.1.6.L93.90",video/mp4; codecs="hev1.2.4.L153.B0"; eotf="smpte2084",video/mp4; codecs="hvc1.2.4.L153.B0"; eotf="smpte2084",video/mp4; codecs="vp9",video/mp4; codecs="vp09.00.10.08",video/mp4; codecs="av01.0.01M.08",audio/mp4; codecs="mp4a.40.2",audio/mp4; codecs="ac-3",audio/mp4; codecs="ec-3",audio/mp4; codecs="opus",audio/mp4; codecs="flac",video/webm; codecs="vp8",video/webm; codecs="vp9",video/webm; codecs="vp09.00.10.08",audio/webm; codecs="vorbis",audio/webm; codecs="opus",video/mp2t; codecs="avc1.42E01E",video/mp2t; codecs="avc3.42E01E",video/mp2t; codecs="hvc1.1.6.L93.90",video/mp2t; codecs="mp4a.40.2",video/mp2t; codecs="ac-3",video/mp2t; codecs="ec-3",text/vtt,application/mp4; codecs="wvtt",application/ttml+xml,application/mp4; codecs="stpp"'.split(",").concat(ia(xi));
k={};p=t(p);for(l=p.next();!l.done;l=p.next())l=l.value,k[l]=oc()?cd(l)?!0:MediaSource.isTypeSupported(l)||Sc(l):pc(l),m=l.split(";")[0],k[m]=k[m]||k[l];d=k;e={manifest:c,media:d,drm:b};f=qm;for(g in f)e[g]=f[g]();return h["return"](e)})};
...
U.registerSupportPlugin=function(a,b){qm[a]=b};U.prototype.destroy=U.prototype.destroy;var hl=0,Sk=1,Hl=2,Sl=3;U.LoadMode={DESTROYED:hl,NOT_LOADED:Sk,MEDIA_SOURCE:Hl,SRC_EQUALS:Sl};U.version="v4.2.1";var rm=["4","2"];ue=new function(a){this.g=a;this.i=ve;this.h=we}(new se(Number(rm[0]),Number(rm[1])));
...
r.requestServerSideStream=function(a,b){b=void 0===b?"":b;if(!this.g)throw new N(1,10,10003);a.adTagParameters||(a.adTagParameters={});var c=a.adTagParameters;(c.mpt||c.mpv)&&Va('You have attempted to set "mpt" and/or "mpv" parameters of the ad tag. Please note that those parameters are used for Shaka adoption tracking and will be overriden.');a.adTagParameters.mpt="shaka-player";a.adTagParameters.mpv="v4.2.1";c=this.g;var d=b;c.j?c=Promise.reject(new N(1,10,10004)):(a instanceof google.ima.dai.api.LiveStreamRequest&&
(c.F=!0),c.j=new lc,c.g.requestStream(a),c.B=d||"",c.G=Date.now()/1E3,c=c.j);return c};r.replaceServerSideAdTagParameters=function(a){if(!this.g)throw new N(1,10,10003);(a.mpt||a.mpv)&&Va('You have attempted to set "mpt" and/or "mpv" parameters of the ad tag. Please note that those parameters are used for Shaka adoption tracking and will be overriden.');a.mpt="Shaka Player";a.mpv="v4.2.1";this.g.g.replaceAdTagParameters(a)};r.getServerSideCuePoints=function(){if(!this.g)throw new N(1,10,10003);return this.g.D};
...
r.cast=function(a){var b=this;return K(function(c){if(!b.m)throw new N(1,8,8E3);if(!Wm)throw new N(1,8,8001);if(b.h)throw new N(1,8,8002);b.l=new lc;chrome.cast.requestSession(function(d){return $m(b,a,d)},function(d){return an(b,d)});return u(c,b.l,0)})};function bn(a){if(a.h){var b=a.L();chrome.cast.requestSession(function(c){return $m(a,b,c)},function(c){return an(a,c)})}}r.yb=function(){if(this.h){Sm(this);if(Tm){Um(this);try{Tm.stop(function(){},function(){})}catch(a){}Tm=null}Qm(this)}};
r.get=function(a,b){var c=this;if("video"==a){if(Im.includes(b))return function(){return c.Ge.apply(c,[a,b].concat(ia(Ia.apply(0,arguments))))}}else if("player"==a){if(Km[b]&&!this.get("player","isLive")())return function(){};if(Nm.includes(b))return function(){return c.Ge.apply(c,[a,b].concat(ia(Ia.apply(0,arguments))))};if(Om.includes(b))return function(){return c.Xf.apply(c,[a,b].concat(ia(Ia.apply(0,arguments))))};if(Jm[b])return function(){return c.g[a][b]}}return this.g[a][b]};
...
r.Ge=function(a,b){Zm(this,{type:"call",targetName:a,methodName:b,args:Ia.apply(2,arguments)})};r.Xf=function(a,b){var c=Ia.apply(2,arguments),d=new lc,e=this.I.toString();this.I++;this.i[e]=d;try{Zm(this,{type:"asyncCall",targetName:a,methodName:b,args:c,id:e})}catch(f){d.reject(f)}return d};function Vm(a,b){var c=a.L();a.l=new lc;a.u=!0;$m(a,c,b)}function Um(a){var b=Tm;b.removeUpdateListener(a.B);b.removeMessageListener("urn:x-cast:com.google.shaka.v2",a.D)}
...
function ko(a){a=t(a.getElementsByTagName("DATA"));for(var b=a.next();!b.done;b=a.next()){b=t(b.value.childNodes);for(var c=b.next();!c.done;c=b.next())if(c=c.value,c instanceof Element&&"LA_URL"==c.tagName)return c.textContent}return""}function lo(a){a=Nn(a.node,"urn:microsoft:playready","pro");if(!a)return"";a=Nc(a.textContent);a=jo(a).filter(function(b){return b.type===mo})[0];if(!a)return"";a=Cc(a.value,!0);return(a=co(a,"WRMHEADER"))?ko(a):""}
...
226,251,75]),m=new Uint8Array([]);k=[{initData:Kn(m,l,k,1),initDataType:"cenc",keyId:f.keyId}]}h=fc(g,f.init||a||h||k);if(g=no.get(g))h.licenseServerUri=g(f);e.push(h)}}return e}function go(a){var b=[];a=t(a);for(var c=a.next();!c.done;c=a.next())(c=oo(c.value))&&b.push(c);return b}
...
p||0;if(0>p)if(q){q=Un(q,"t",$n);if(null==q)break;else if(v>=q)break;p=Math.ceil((q-v)/y)-1}else{if(Infinity==k)break;else if(v/f>=k)break;p=Math.ceil((k*f-v)/y)-1}0<l.length&&v!=m&&(l[l.length-1].end=v/f);for(q=0;q<=p;++q)m=v+y,l.push({start:v/f,end:m/f,mg:v}),v=m}f=l}return{timescale:d,ga:c,Kb:g,Sa:e/d||0,he:e,timeline:f}}function ro(a,b,c){return[b(a.H),b(a.ja),b(a.aa)].filter(dc).map(function(d){return d.getAttribute(c)}).reduce(function(d,e){return d||e})}
function so(a,b,c){return[b(a.H),b(a.ja),b(a.aa)].filter(dc).map(function(d){return Ln(d,c)}).reduce(function(d,e){return d||e})}
function to(a,b,c,d,e,f){for(var g=Qn(a,"http://www.w3.org/1999/xlink","href"),h=Qn(a,"http://www.w3.org/1999/xlink","actuate")||"onRequest",k=t(Array.from(a.attributes)),l=k.next();!l.done;l=k.next())l=l.value,"http://www.w3.org/1999/xlink"==l.namespaceURI&&a.removeAttributeNS(l.namespaceURI,l.localName);if(5<=f)return Oe(new N(2,4,4028));if("onLoad"!=h)return Oe(new N(2,4,4027));var m=ec([d],[g]);return e.request(0,ef(m,b)).Z(function(n){n=eo(n.data,a.tagName);if(!n)return Oe(new N(2,4,4001,g));
...
function zo(a){var b=a.g.$(),c=a.g.Ra();if(0==c)throw new N(2,3,3002);c=8-Math.floor(Math.log2(c));a.g.skip(c-1);return Fb(a.h,b,c)}var Ao=[[255],[127,255],[63,255,255],[31,255,255,255],[15,255,255,255,255],[7,255,255,255,255,255],[3,255,255,255,255,255,255],[1,255,255,255,255,255,255,255]];function Bo(a,b){this.id=a;this.g=b}
...
function Go(a){var b=a.H;return{bandwidth:a.bandwidth,audioSamplingRate:b.audioSamplingRate,codecs:b.codecs,contentType:b.contentType,frameRate:b.frameRate||null,height:b.height||null,mimeType:b.mimeType,channelsCount:b.Uc,pixelAspectRatio:b.pixelAspectRatio||null,width:b.width||null}};function No(a,b){var c=Fo(a,Oo),d=Po(a);if(!d.ga&&!d.timeline&&1<d.Eb.length)throw new N(2,4,4002);if(!d.ga&&!a.W.duration&&!d.timeline&&1==d.Eb.length)throw new N(2,4,4002);if(d.timeline&&0==d.timeline.length)throw new N(2,4,4002);var e=null,f=null;a.aa.id&&a.H.id&&(f=b[a.aa.id+","+a.H.id])&&(e=f.segmentIndex);var g=Qo(a.W.start,a.W.duration,a.H.wa,d,c);c=!e;e?e.Fb(g,a.presentationTimeline.Pa()):e=new Ui(g);a.presentationTimeline.Gb(g);a.Wa&&a.W.ze||e.Xa(a.W.start,a.W.duration?a.W.start+a.W.duration:
Infinity,c);f&&(f.segmentIndex=e);return{zb:function(){e&&0!=e.J.length||e.mc(g);return Promise.resolve(e)}}}function Oo(a){return a.$a}function Po(a){var b=Ro(a);a=qo(a,Oo);var c=a.Kb;0==c&&(c=1);var d=0;a.ga?d=a.ga*(c-1):a.timeline&&0<a.timeline.length&&(d=a.timeline[0].start);return{ga:a.ga,startTime:d,Kb:c,Sa:a.Sa,timeline:a.timeline,Eb:b}}
function Qo(a,b,c,d,e){var f=d.Eb.length;d.timeline&&d.timeline.length!=d.Eb.length&&(f=Math.min(d.timeline.length,d.Eb.length));for(var g=a-d.Sa,h=b?a+b:Infinity,k=[],l=d.startTime,m={},n=0;n<f;m={kd:m.kd},n++){var p=d.Eb[n];m.kd=ec(c,[p.Nf]);var q=void 0;q=null!=d.ga?l+d.ga:d.timeline?d.timeline[n].end:l+b;k.push(new Sh(a+l,a+q,function(v){return function(){return v.kd}}(m),p.start,p.end,e,g,a,h));l=q}return k}
function Ro(a){return[a.H.$a,a.ja.$a,a.aa.$a].filter(dc).map(function(b){return Mn(b,"SegmentURL")}).reduce(function(b,c){return 0<b.length?b:c}).map(function(b){b.getAttribute("indexRange")&&!a.xe&&(a.xe=!0);var c=b.getAttribute("media");b=Un(b,"mediaRange",Xn,{start:0,end:null});return{Nf:c,start:b.start,end:b.end}})};function So(a,b,c,d,e,f){var g=To(a),h=Uo(a);Vo(h);var k=Ye(a);if(h.kc)return Mo(a,g),{zb:function(){var q=po(h.kc,k.H.id,null,k.bandwidth||null,null);q=ec(k.H.wa,[q]);return Lo(k,b,g,q,0,null,h.Sa)}};if(h.ga)return d||(a.presentationTimeline.Ld(h.ga),a.presentationTimeline.Md(a.W.start)),{zb:function(){return Wo(k,h,e,g,f)}};var l=null;d=d=null;a.aa.id&&a.H.id&&(d=a.aa.id+","+a.H.id,d=c[d])&&(l=d.segmentIndex);var m=Xo(k,h,g);c=a.W.start;var n=a.W.duration?a.W.start+a.W.duration:Infinity,p=Infinity!=
n;l?(p&&(new Ui(m)).Xa(c,n,!0),l.Fb(m,a.presentationTimeline.Pa())):l=new Ui(m);a.presentationTimeline.Gb(m);p&&l.Xa(c,n);d&&a.Wa&&(d.segmentIndex=l);return{zb:function(){l&&0!=l.J.length||l.mc(m);return Promise.resolve(l)}}}function Yo(a){return a.uc}function Uo(a){var b=qo(a,Yo),c=ro(a,Yo,"media");a=ro(a,Yo,"index");return{ga:b.ga,timescale:b.timescale,Kb:b.Kb,Sa:b.Sa,he:b.he,timeline:b.timeline,Jd:c,kc:a}}
...
function Wo(a,b,c,d,e){function f(I){var L=(I-q)*p,P=L+b.Sa,S=L+l;L=S+p;var Y=Math.min(L,h());S=new Sh(S,Y,function(){var ea=po(y,w,I,x,P*v);return ec(D,[ea])},0,null,d,B,l,h());S.j=L;return S}function g(){var I=[Math.max(k.Pa(),l),Math.min(k.fb(),h())].map(function(L){return L-l});return[Math.ceil(I[0]/p),Math.ceil(I[1]/p)-1].map(function(L){return L+q})}function h(){var I=null!=m&&e[m]||n;return I?l+I:Infinity}var k=a.presentationTimeline,l=a.W.start,m=a.aa.id,n=a.W.duration,p=b.ga,q=b.Kb,v=b.timescale,
y=b.Jd,x=a.bandwidth||null,w=a.H.id,D=a.H.wa,B=l-b.Sa,A=g();a=a.Wa?Math.max(A[0],A[1]-c+1):A[0];A=A[1];c=[];for(var G=a;G<=A;++G){var E=f(G);c.push(E)}var H=new Ui(c);c=k.fb()<h();G=k.V();if(c||G){var J=Math.max(a,A+1);H.ad(p,function(){var I=k.Pa();H.cb(I);var L=t(g());L.next();L=L.next().value;for(var P=[];J<=L;){var S=f(J);P.push(S);J++}return I>h()&&!P.length?null:P})}return Promise.resolve(H)}
function Xo(a,b,c){var d=a.W.start,e=a.W.duration,f=d-b.Sa;e=e?d+e:Infinity;for(var g=[],h={},k=0;k<b.timeline.length;h={jd:h.jd,nd:h.nd,qd:h.qd,fd:h.fd,sd:h.sd,gd:h.gd},k++){var l=b.timeline[k],m=l.start,n=l.mg;l=l.end;h.qd=k+b.Kb;h.sd=n+b.he;h.nd=a.H.id;h.fd=a.bandwidth||null;h.jd=b.Jd;h.gd=a.H.wa;g.push(new Sh(d+m,d+l,function(p){return function(){var q=po(p.jd,p.nd,p.qd,p.fd||null,p.sd);return ec(p.gd,[q]).map(function(v){return v.toString()})}}(h),0,null,c,f,d,e))}return g}
function To(a){var b=ro(a,Yo,"initialization");if(!b)return null;var c=a.H.id,d=a.bandwidth||null,e=a.H.wa;return new Qh(function(){var f=po(b,c,null,d,null);return ec(e,[f])},0,null,Go(a))};function Zo(){this.l=[];this.g=[];this.h=[];this.j=[];this.i=[];this.m=new Set}Zo.prototype.release=function(){for(var a=t(this.g.concat(this.h,this.j,this.i)),b=a.next();!b.done;b=a.next())b=b.value,b.segmentIndex&&b.segmentIndex.release();this.g=[];this.h=[];this.j=[];this.i=[];this.l=[]};
function $o(a,b,c){var d,e,f,g,h,k,l,m,n,p,q,v,y,x,w,D,B,A,G,E,H,J,I,L,P,S,Y,ea,ta,Ca;return K(function(Da){switch(Da.g){case 1:d=kc;ap(b);bp(b);cp(b);dp(b);if(!c&&1==b.length){e=b[0];a.g=e.Ec;a.h=e.cd;a.j=e.textStreams;a.i=e.imageStreams;Da.A(2);break}f=-1;for(g=0;g<b.length;g++)h=b[g],a.m.has(h.id)||(a.m.add(h.id),-1==f&&(f=g));if(-1==f)return Da["return"]();k=b.map(function(Ga){return Ga.Ec});l=b.map(function(Ga){return Ga.cd});m=b.map(function(Ga){return Ga.textStreams});n=b.map(function(Ga){return Ga.imageStreams});
p=t(m);for(q=p.next();!q.done;q=p.next())v=q.value,v.push(ep(d.X));y=t(n);for(x=y.next();!x.done;x=y.next())w=x.value,w.push(ep(d.Ub));return u(Da,fp(a.g,k,f,gp,hp),3);case 3:return u(Da,fp(a.h,l,f,gp,hp),4);case 4:return u(Da,fp(a.j,m,f,gp,hp),5);case 5:return u(Da,fp(a.i,n,f,gp,hp),2);case 2:D=0;B=[];if(a.h.length&&a.g.length)for(I=t(a.g),L=I.next();!L.done;L=I.next())for(P=L.value,S=t(a.h),Y=S.next();!Y.done;Y=S.next())ea=Y.value,ta=jg(P.drmInfos,ea.drmInfos),P.drmInfos.length&&ea.drmInfos.length&&
!ta.length||(Ca=D++,B.push({id:Ca,language:P.language,primary:P.primary,audio:P,video:ea,bandwidth:(P.bandwidth||0)+(ea.bandwidth||0),drmInfos:ta,allowedByApplication:!0,allowedByKeySystem:!0,decodingInfos:[]}));else for(A=a.h.concat(a.g),G=t(A),E=G.next();!E.done;E=G.next())H=E.value,J=D++,B.push({id:J,language:H.language,primary:H.primary,audio:H.type==d.bb?H:null,video:H.type==d.va?H:null,bandwidth:H.bandwidth||0,drmInfos:H.drmInfos,allowedByApplication:!0,allowedByKeySystem:!0,decodingInfos:[]});
a.l=B;z(Da)}})}function ap(a){a=t(a);for(var b=a.next();!b.done;b=a.next()){b=b.value;for(var c=[],d=t(b.Ec),e=d.next();!e.done;e=d.next()){e=e.value;for(var f=!1,g=t(c),h=g.next();!h.done;h=g.next())h=h.value,e.id!=h.id&&e.channelsCount==h.channelsCount&&e.language==h.language&&e.bandwidth==h.bandwidth&&e.label==h.label&&e.codecs==h.codecs&&e.mimeType==h.mimeType&&fb(e.roles,h.roles)&&e.audioSamplingRate==h.audioSamplingRate&&e.primary==h.primary&&(f=!0);f||c.push(e)}b.Ec=c}}
...
function fp(a,b,c,d,e){var f,g,h,k,l,m,n,p,q,v,y,x,w,D,B,A,G,E,H,J,I;return K(function(L){switch(L.g){case 1:f=kc;g=[];for(h=0;h<b.length;h++)h>=c?g.push(new Set(b[h])):g.push(new Set);k=t(a);l=k.next();case 2:if(l.done){L.A(4);break}m=l.value;return u(L,mp(m,b,c,e,g),5);case 5:n=L.h;if(!n)throw new N(2,4,4037);l=k.next();L.A(2);break;case 4:p=t(g);for(q=p.next();!q.done;q=p.next())for(v=q.value,y=t(v),x=y.next();!x.done;x=y.next())w=x.value,(D=np(w,b,d,e,g))&&a.push(D);B=t(g);for(q=B.next();!q.done;q=
B.next())for(A=q.value,G={},E=t(A),x=E.next();!x.done;G={Va:G.Va},x=E.next())if(G.Va=x.value,H=G.Va.type==f.X&&!G.Va.language,J=G.Va.type==f.Ub&&!G.Va.tilesLayout,!H&&!J&&(I=a.some(function(P){return function(S){return S.mimeType==P.Va.mimeType&&Zc(S.codecs)==Zc(P.Va.codecs)}}(G))))throw new N(2,4,4037);return L["return"](a)}})}
...
function Ip(a,b,c){var d,e,f,g,h,k,l,m,n,p,q,v,y,x,w,D,B,A,G,E,H,J,I,L,P,S,Y,ea,ta,Ca,Da,Ga;return K(function(Ha){switch(Ha.g){case 1:(d=a.g.dash.manifestPreprocessor)&&d(b);e=[c];f=Mn(b,"Location").map(Sn).filter(dc);0<f.length&&(g=ec(e,f),e=a.m=g);h=Mn(b,"BaseURL");k=h.map(Sn);l=ec(e,k);m=0;h&&h.length&&(m=Un(h[0],"availabilityTimeOffset",ao)||0);n=a.g.dash.ignoreMinBufferTime;p=0;n||(p=Un(b,"minBufferTime",Wn)||0);a.F=Un(b,"minimumUpdatePeriod",Wn,-1);q=Un(b,"availabilityStartTime",Vn);v=Un(b,
"timeShiftBufferDepth",Wn);y=a.g.dash.ignoreSuggestedPresentationDelay;x=null;y||(x=Un(b,"suggestedPresentationDelay",Wn));w=a.g.dash.ignoreMaxSegmentDuration;D=null;w||(D=Un(b,"maxSegmentDuration",Wn));B=b.getAttribute("type")||"static";if(a.i)for(A=a.i.presentationTimeline,G=t(Object.values(a.l)),E=G.next();!E.done;E=G.next())H=E.value,H.segmentIndex&&H.segmentIndex.cb(A.Pa());else J=a.g.defaultPresentationDelay||1.5*p,I=null!=x?x:J,A=new T(q,I,a.g.dash.autoCorrectDrift);A.vc("static"==B);(L=A.V())&&
!isNaN(a.g.availabilityWindowOverride)&&(v=a.g.availabilityWindowOverride);null==v&&(v=Infinity);A.ce(v);P=b.getAttribute("profiles")||"";S={Wa:"static"!=B,presentationTimeline:A,aa:null,W:null,ja:null,H:null,bandwidth:0,xe:!1,xb:m,profiles:P.split(",")};Y=Jp(a,S,l,b);ea=Y.duration;ta=Y.periods;"static"!=B&&Y.qe||A.Ia(ea||Infinity);a.u&&!a.B&&(Ca=a.h.isAutoLowLatencyMode())&&(a.h.enableLowLatencyMode(),a.B=a.h.isLowLatencyMode());a.B?A.Ke(a.u):a.u&&Va("Low-latency DASH live stream detected, but low-latency streaming mode is not enabled in Shaka Player. Set streaming.lowLatencyMode configuration to true, and see https://bit.ly/3clctcj for details.");
A.Ld(D||1);return u(Ha,$o(a.j,ta,S.Wa),2);case 2:if(a.i){a.i.variants=a.j.l;a.i.textStreams=a.j.j.slice();a.i.imageStreams=a.j.i;a.h.filter(a.i);Ha.A(3);break}a.i={presentationTimeline:A,variants:a.j.l,textStreams:a.j.j.slice(),imageStreams:a.j.i,offlineSessionIds:[],minBufferTime:p||0,sequenceMode:!1};if(!A.Pe()){Ha.A(4);break}Da=Mn(b,"UTCTiming");return u(Ha,Kp(a,l,Da),5);case 5:Ga=Ha.h;if(!a.h)return Ha["return"]();A.Le(Ga);case 4:A.Fd();case 3:a.h.makeTextStreamsForClosedCaptions(a.i),z(Ha)}})}
...
function Lp(a,b,c,d){b.aa=Mp(d.node,null,c);b.W=d;b.aa.xb=b.xb;b.aa.id||(b.aa.id="__shaka_period_"+d.start);var e=Mn(d.node,"EventStream");c=b.presentationTimeline.Pa();e=t(e);for(var f=e.next();!f.done;f=e.next())Np(a,d.start,d.duration,f.value,c);c=Mn(d.node,"AdaptationSet").map(function(m){return Op(a,b,m)}).filter(dc);if(b.Wa){d=[];e=t(c);for(f=e.next();!f.done;f=e.next()){f=t(f.value.Zf);for(var g=f.next();!g.done;g=f.next())d.push(g.value)}if(d.length!=(new Set(d)).size)throw new N(2,4,4018);
...
m.value,p=t(B.drmInfos),q=p.next();!q.done;q=p.next())q=q.value,q.keyIds=q.keyIds&&m.keyIds?new Set([].concat(ia(q.keyIds),ia(m.keyIds))):q.keyIds||m.keyIds;k=l.map(function(E){return E.getAttribute("id")}).filter(dc);return{id:b.ja.id||"__fake__"+a.G++,contentType:b.ja.contentType,language:A,$g:e,streams:c,drmInfos:B.drmInfos,fe:f,Zf:k}}
function Qp(a,b,c,d,e,f,g,h,k,l){b.H=Mp(l,b.ja,null);a.u=Math.min(a.u,b.H.xb);if(!Sp(b.H))return null;var m=b.W.start;b.bandwidth=Un(l,"bandwidth",Zn)||0;var n=b.H.contentType,p=n==jc||"application"==n;n="image"==n;try{var q=function(H,J,I){return Tp(a,H,J,I)};if(b.H.tc)var v=Ho(b,q);else if(b.H.$a)v=No(b,a.l);else if(b.H.uc)v=So(b,q,a.l,!!a.i,a.g.dash.initialSegmentLimit,a.M);else{var y=b.H.wa,x=b.W.duration||0;v={zb:function(){return Promise.resolve(Wi(m,x,y))}}}}catch(H){if((p||n)&&4002==H.code)return null;
...
parseInt(c,16);if(!b)continue;for(a=0;b;)b&1&&++a,b>>=1;return a;case "urn:mpeg:mpegB:cicp:ChannelConfiguration":if(b=[0,1,2,3,4,5,6,8,2,3,4,7,8,24,8,12,10,12,14,12,14],(c=parseInt(c,10))&&0<c&&c<b.length)return b[c]}}return null}function Sp(a){var b=a.tc?1:0;b+=a.$a?1:0;b+=a.uc?1:0;if(0==b)return a.contentType==jc||"application"==a.contentType?!0:!1;1!=b&&(a.tc&&(a.$a=null),a.uc=null);return!0}
...
M("shaka.net.DataUriPlugin",oq);oq.parse=pq;bf("data",pq);function rq(){var a=this;this.h=this.j=null;this.La=1;this.o=new Map;this.u=new Map;this.ua=new Set;this.g=new Map;this.i=null;this.L="";this.ca=new jq;this.ia=0;this.T=!1;this.M=null;this.B=new O(function(){sq(a)});this.m=tq;this.G=null;this.ea=0;this.F=Infinity;this.Y=this.ha=0;this.D=new Ze;this.O=[];this.I=new Map;this.s=new Map;this.da=new Map;this.l=!1}r=rq.prototype;r.configure=function(a){this.h=a};
r.start=function(a,b){var c=this,d,e;return K(function(f){if(1==f.g)return c.j=b,c.l=b.isLowLatencyMode(),u(f,uq(c,a),2);if(3!=f.g)return d=f.h,c.L=d.uri,u(f,vq(c,d.data,a),3);e=c.ia;0<e&&c.B.R(e);return f["return"](c.G)})};r.stop=function(){this.B&&(this.B.stop(),this.B=null);var a=[];this.D&&(a.push(this.D.destroy()),this.D=null);this.h=this.j=null;this.ua.clear();this.G=null;this.g.clear();this.u.clear();this.s.clear();this.o.clear();return Promise.all(a)};
...
function wq(a,b){var c,d,e,f,g,h,k,l,m,n,p,q,v;return K(function(y){if(1==y.g)return c=xq,d=b.Te,e=new Nb(d),a.l&&b.Ye&&Qb(e,new Sb("_HLS_skip=YES")),u(y,uq(a,e.toString()),2);f=y.h;g=kq(a.ca,f.data,f.uri);if(1!=g.type)throw new N(2,4,4017);h=aq(g.g,"EXT-X-DEFINE");k=yq(a,h);l=b.stream;m=zq(a,g,l.type,b.lc,k);l.segmentIndex.Fb(m,a.i.Pa());m.length&&(n=dq(g.g),p=b.lc.get(n),l.segmentIndex.cb(p));q=m[m.length-1];if(v=cq(g.g,"EXT-X-ENDLIST"))Aq(a,c.Se),a.i.Ia(q.endTime);z(y)})}
...
disabledUntilTime:0,primary:!0,audio:"audio"==H?L.stream:null,video:"video"==H?L.stream:null,bandwidth:0,allowedByApplication:!0,allowedByKeySystem:!0,decodingInfos:[]});case 3:if(!a.j)throw new N(2,7,7001);a.h.hls.ignoreManifestProgramDateTime?Bq(a):Dq(a);P=Infinity;S=t(a.g.values());for(Y=S.next();!Y.done;Y=S.next())ea=Y.value,"text"!=ea.stream.type&&(P=Math.min(P,ea.Hd));a.m!=tq?(a.i=new T(0,a.h.defaultPresentationDelay?a.h.defaultPresentationDelay:a.Y?a.Y:3*a.ea),a.i.vc(!1)):(a.i=new T(null,0),
a.i.vc(!0));if(a.m!=tq)a.ia=a.F,ta=xq,a.m==ta.Re&&(Ca=a.i.Zc,isNaN(a.h.availabilityWindowOverride)||(Ca=a.h.availabilityWindowOverride),a.i.ce(Ca));else for(a.i.Ia(P),Da=t(a.g.values()),Y=Da.next();!Y.done;Y=Da.next())Ga=Y.value,Ga.stream.segmentIndex.Xa(0,P);a.O=[];Ha=[];Fc=t(f);for(Tb=Fc.next();!Tb.done;Tb=Fc.next())for(pd=Tb.value,qd=t([pd.video,pd.audio]),rb=qd.next();!rb.done;rb=qd.next())(rd=rb.value)&&Ha.push(rd);return u(Ra,Promise.all(Ha.map(function(Gf){return K(function(Hf){return u(Hf,
Gf.createSegmentIndex(),0)})})),9);case 9:Gc=t(Ha);for(rb=Gc.next();!rb.done;rb=Gc.next())Hc=rb.value,a.O.push(Hc.segmentIndex.J);Mq(a);a.i.Fd();a.G={presentationTimeline:a.i,variants:f,textStreams:g,imageStreams:h,offlineSessionIds:[],minBufferTime:0,sequenceMode:!0};a.j.makeTextStreamsForClosedCaptions(a.G);z(Ra)}})}function Eq(a,b){for(var c=t(b),d=c.next();!d.done;d=c.next()){var e=d.value;d=Z(e,"NAME");e=Z(e,"VALUE");d&&e&&(a.o.has(d)||a.o.set(d,e))}}
function yq(a,b){for(var c=new Map,d=t(b),e=d.next();!e.done;e=d.next()){var f=e.value;e=Z(f,"NAME");var g=Z(f,"VALUE");f=Z(f,"IMPORT");e&&g&&c.set(e,g);f&&(e=a.o.get(f))&&c.set(f,e)}return c}function Gq(a,b){for(var c=t(b),d=c.next();!d.done;d=c.next()){var e=d.value,f=Z(e,"AUDIO");d=Z(e,"VIDEO");var g=Z(e,"SUBTITLES");e=Nq(a,e);if(g){var h=hc(jc,e);a.s.set(g,h);eb(e,h)}f&&(g=gc("audio",e),a.s.set(f,g));d&&(f=gc("video",e),a.s.set(d,f))}}
...
function Jq(a,b){var c,d,e;return K(function(f){if(1==f.g)return c=b.map(function(g){var h,k,l,m,n,p,q,v;return K(function(y){if(1==y.g)return h=Z(g,"FRAME-RATE"),k=Number(Z(g,"AVERAGE-BANDWIDTH"))||Number(Yp(g,"BANDWIDTH")),l=Z(g,"RESOLUTION"),m=t(l?l.split("x"):[null,null]),n=m.next().value,p=m.next().value,q=Z(g,"VIDEO-RANGE"),u(y,Qq(a,g),2);v=y.h;for(var x=y["return"],w=v.audio,D=v.video,B=t(D),A=B.next();!A.done;A=B.next())if(A=A.value.stream)A.width=Number(n)||void 0,A.height=Number(p)||void 0,
A.frameRate=Number(h)||void 0,A.hdr=q||void 0;B=a.h.disableAudio;if(!w.length||B)w=[null];B=a.h.disableVideo;if(!D.length||B)D=[null];B=[];w=t(w);for(A=w.next();!A.done;A=w.next()){A=A.value;for(var G=t(D),E=G.next();!E.done;E=G.next()){var H=E.value;E=A?A.stream:null;var J=H?H.stream:null,I=A?A.stream.drmInfos:null,L=H?H.stream.drmInfos:null;H=(H?H.bd:"")+" - "+(A?A.bd:"");E&&J&&I.length&&L.length&&!(0<jg(I,L).length)||a.ua.has(H)||(E={id:a.La++,language:E?E.language:"und",primary:!!E&&E.primary||
!!J&&J.primary,audio:E,video:J,bandwidth:k,allowedByApplication:!0,allowedByKeySystem:!0,decodingInfos:[]},B.push(E),a.ua.add(H))}}return x.call(y,B)})}),u(f,Promise.all(c),2);d=f.h;e=d.reduce(bc,[]);e=e.filter(function(g){return null!=g});return f["return"](e)})}
function Qq(a,b){var c,d,e,f,g,h,k,l,m,n,p,q,v,y;return K(function(x){if(1==x.g)return c=kc,d=Nq(a,b),e=Z(b,"AUDIO"),f=Z(b,"VIDEO"),h=(g=e||f)&&a.u.has(g)?a.u.get(g):[],k={audio:e?h:[],video:f?h:[]},m=!1,n=Yp(b,"URI"),p=k.audio.find(function(w){return w&&w.bd==n}),q=hc(c.va,d),(v=hc(c.bb,d))&&!q?l=c.bb:!h.length&&v&&q?(l=c.va,d=[[q,v].join()]):k.audio.length&&p?(l=c.bb,m=!0):l=k.video.length?c.bb:c.va,m?x.A(2):u(x,Rq(a,b,d,l),3);2!=x.g&&(y=x.h,k[y.stream.type]=[y]);Sq(k);return x["return"](k)})}
function Nq(a,b){var c=[];a.h.disableVideo||c.push(a.h.hls.defaultVideoCodec);a.h.disableAudio||c.push(a.h.hls.defaultAudioCodec);var d=Z(b,"CODECS",c.join(",")).split(/\s*,\s*/);c=new Set;var e=[];d=t(d);for(var f=d.next();!f.done;f=d.next()){f=f.value;var g=$c(f)[0];c.has(g)||(e.push(f),c.add(g))}return e}function Tq(a){a=Z(a,"LANGUAGE")||"und";return Q(a)}
...
v="YES"==q;return u(x,Vq(a,f,d,e,g,l,h,m,null,p,v,n),2)}y=x.h;a.u.has(c)?a.u.get(c).push(y):a.u.set(c,[y]);if(a.g.has(f))return x["return"](a.g.get(f));a.g.set(f,y);return x["return"](y)})}
...
if(n=Z(b,"BANDWIDTH"))h.stream.bandwidth=Number(n);a.g.set(c,h);return p["return"](h)})}function Rq(a,b,c,d){var e,f,g,h;return K(function(k){if(1==k.g){e=Uq(Yp(b,"URI"),a.o);if(a.g.has(e))return k["return"](a.g.get(e));var l=Z(b,"CLOSED-CAPTIONS");f="video"==d&&l&&"NONE"!=l?a.I.get(l):null;g=gc(d,c);return u(k,Vq(a,e,g,d,"und",!1,null,null,f,null,!1,!1),2)}h=k.h;if(a.g.has(e))return k["return"](a.g.get(e));a.g.set(e,h);return k["return"](h)})}
function Vq(a,b,c,d,e,f,g,h,k,l,m,n){var p,q,v;return K(function(y){if(1==y.g)return p=eq(a.L,b),u(y,uq(a,p),2);q=y.h;p=q.uri;v=kq(a.ca,q.data,p);return y["return"](Fq(a,v,b,p,c,d,e,f,g,h,k,l,m,n))})}
function Fq(a,b,c,d,e,f,g,h,k,l,m,n,p,q,v){var y,x,w,D,B,A,G,E,H,J,I,L,P,S,Y,ea,ta,Ca,Da,Ga,Ha,Fc,Tb,pd,qd,rb,rd,Gc,Hc,Ra,Gf,Hf,fn;return K(function(td){if(1==td.g){if(1!=b.type)throw new N(2,4,4017);y=aq(b.g,"EXT-X-DEFINE");x=yq(a,y);Wq(a,b);return v?td.A(2):u(td,Xq(a,f,e,b,x),3)}2!=td.g&&(v=td.h);w=[];if(b.segments)for(D=t(b.segments),B=D.next();!B.done;B=D.next())A=B.value,G=aq(A.g,"EXT-X-KEY"),w.push.apply(w,ia(G));H=E=!1;J=[];I=new Set;L=t(w);for(P=L.next();!P.done;P=L.next())if(S=P.value,Y=
Yp(S,"METHOD"),"NONE"!=Y)if(E=!0,"AES-128"==Y)H=!0;else if(ea=Yp(S,"KEYFORMAT"),Ca=(ta=Yq[ea])?ta(S,v):null){if(Ca.keyIds)for(Da=t(Ca.keyIds),Ga=Da.next();!Ga.done;Ga=Da.next())Ha=Ga.value,I.add(Ha);J.push(Ca)}if(E&&!J.length&&!H)throw new N(2,4,4026);xi.includes(v)&&(e="");Fc=new Map;Tb=zq(a,b,f,Fc,x);pd=Tb[Tb.length-1].endTime;qd=new Ui(Tb);rb=f==jc?"subtitle":void 0;rd=[];if(n)for(Gc=t(n.split(",")),Hc=Gc.next();!Hc.done;Hc=Gc.next())Ra=Hc.value,rd.push(Ra);Hf=(Gf=cq(b.g,"EXT-X-SERVER-CONTROL"))?
null!=Gf.getAttribute("CAN-SKIP-UNTIL"):!1;fn={id:a.La++,originalId:k,createSegmentIndex:function(){return Promise.resolve()},segmentIndex:qd,mimeType:v,codecs:e,kind:rb,encrypted:E,drmInfos:J,keyIds:I,language:g,label:k,type:f,primary:h,trickModeVideo:null,emsgSchemeIdUris:null,frameRate:void 0,pixelAspectRatio:void 0,width:void 0,height:void 0,bandwidth:void 0,roles:rd,forced:p,channelsCount:l,audioSamplingRate:null,spatialAudio:q,closedCaptions:m,hdr:void 0,tilesLayout:void 0};return td["return"]({stream:fn,
bd:c,Te:d,Hd:pd,lc:Fc,Ye:Hf})})}
...
function Wq(a,b){var c=cq(b.g,"EXT-X-PLAYLIST-TYPE"),d=cq(b.g,"EXT-X-ENDLIST");d=c&&"VOD"==c.value||d;c=c&&"EVENT"==c.value&&!d;c=!d&&!c;if(d)Aq(a,tq);else{c?Aq(a,ar):Aq(a,br);d=cq(b.g,"EXT-X-TARGETDURATION");if(!d)throw new N(2,4,4024,"EXT-X-TARGETDURATION");d=Number(d.value);c=cq(b.g,"EXT-X-PART-INF");a.l&&c?(a.ha=Number(Yp(c,"PART-TARGET")),a.F=Math.min(a.ha,a.F),c=cq(b.g,"EXT-X-SERVER-CONTROL"),a.Y=c?Number(Yp(c,"PART-HOLD-BACK")):0):a.F=Math.min(d,a.F);a.ea=Math.max(d,a.ea)}}
function cr(a,b,c,d){c=cq(c,"EXT-X-MAP");if(!c)return null;var e=Yp(c,"URI");d=Uq(eq(b,e),d);b=[d,Z(c,"BYTERANGE","")].join("-");a.da.has(b)||(c=dr(d,c),a.da.set(b,c));return a.da.get(b)}function dr(a,b){var c=0,d=null,e=Z(b,"BYTERANGE");e&&(c=e.split("@"),d=Number(c[0]),c=Number(c[1]),d=c+d-1);return new Qh(function(){return[a]},c,d)}
...
y,e,b.h,c,g))&&(a.h.hls.ignoreManifestProgramDateTime&&null!=a.M&&l<a.M||n.push(v))}if(a=n.some(function(D){return null!=D.g}))for(b={},c=0;c<n.length;b={Pb:b.Pb,Ob:b.Ob,xc:b.xc,Ta:b.Ta,Nb:b.Nb},c++)if(b.Ta=n[c],null==b.Ta.g)for(b.Ob=0,b.Pb=c,d=function(D){return function(){var B=n[D.Pb];if(B){if(null!=B.g)return B.g+D.Ob;D.Ob-=B.endTime-B.startTime;D.Pb+=1}return null}}(b),b.Nb=0,b.xc=c,e=function(D){return function(){var B=n[D.xc];if(B){B!=D.Ta&&(D.Nb+=B.endTime-B.startTime);if(null!=B.g)return B.g+
D.Nb;--D.xc}return null}}(b);null==b.Ta.g;)b.Ta.g=e(),null==b.Ta.g&&(b.Ta.g=d());if(a)for(a=t(n),b=a.next();!b.done;b=a.next())for(c=b.value,b=c.g,c=t(c.h),d=c.next();!d.done;d=c.next())d=d.value,d.g=b,b+=d.endTime-d.startTime;return n}function Uq(a,b){var c=String(a).replace(/%7B/g,"{").replace(/%7D/g,"}"),d=c.match(/{\$\w*}/g);if(d){d=t(d);for(var e=d.next();!e.done;e=d.next()){e=e.value;var f=e.slice(2,e.length-1),g=b.get(f);if(g)c=c.replace(e,g);else throw new N(2,4,4039,f);}}return c}
...
function Yr(a){var b,c,d;return K(function(e){return 1==e.g?(b=Array.from(a.g.values()),c=0<b.length,c||(d=Sr,d.forEach(function(f){(f=f())&&b.push(f)})),u(e,Promise.all(b.map(function(f){return f.erase()})),2)):c?e.A(0):u(e,Promise.all(b.map(function(f){return f.destroy()})),0)})}function Zr(a,b){Sr.set(a,b)}M("shaka.offline.StorageMuxer",Rr);Rr.unregister=function(a){Sr["delete"](a)};Rr.register=Zr;Rr.prototype.destroy=Rr.prototype.destroy;var Sr=new Map;function $r(){Lr.apply(this,arguments)}pa($r,Lr);$r.prototype.updateManifestExpiration=function(a,b){var c=this,d,e,f;return K(function(g){d=Jr(c.h,c.g);e=d.store();f=new lc;e.get(a).onsuccess=function(h){(h=h.target.result)?(h.expiration=b,e.put(h),f.resolve()):f.reject(new N(2,9,9012,"Could not find values for "+a))};return u(g,Promise.all([d.promise(),f]),0)})};
...
function ms(a,b){var c=new T(null,0);c.Ia(b.duration);var d=b.streams.filter(function(l){return"audio"==l.type}),e=b.streams.filter(function(l){return"video"==l.type});d=ns(a,d,e,c);e=b.streams.filter(function(l){return l.type==jc}).map(function(l){return os(a,l,c)});var f=b.streams.filter(function(l){return"image"==l.type}).map(function(l){return os(a,l,c)}),g=b.drmInfo?[b.drmInfo]:[];if(b.drmInfo)for(var h=t(d.values()),k=h.next();!k.done;k=h.next())k=k.value,k.audio&&k.audio.encrypted&&(k.audio.drmInfos=
...
function Ps(a,b,c,d,e,f,g,h,k){var l,m,n,p,q,v,y,x,w,D;return K(function(B){switch(B.g){case 1:l={};m=0;n=function(A,G){var E,H,J,I,L,P,S;return K(function(Y){if(1==Y.g){E={};H=t(A);for(J=H.next();!J.done;E={ab:E.ab},J=H.next())E.ab=J.value,I=xr(E.ab,f),L=E.ab.i,P=E.ab.h,S=function(ea){return function(ta){var Ca,Da,Ga;return K(function(Ha){if(1==Ha.g)return u(Ha,g.addSegments([{data:ta}]),2);Ca=Ha.h;Ls(a);Da=ea.ab.g;Ga=wr(Da);l[Ga]=Ca[0];m+=ta.byteLength;z(Ha)})}}(E),Dr(e,E.ab.groupId,I,L,P,S);return u(Y,
...
function Ns(a,b){var c,d,e,f,g,h,k,l,m,n,p,q,v,y,x,w,D,B,A,G,E,H,J,I,L,P,S,Y,ea;return K(function(ta){switch(ta.g){case 1:return c={width:Infinity,height:Infinity},Ld(a,b.restrictions,c),u(ta,Pd(a,b.offline.usePersistentLicense),2);case 2:d=[];e=b.preferredAudioChannelCount;f=b.preferredDecodingAttributes;g=b.preferredVideoCodecs;h=b.preferredAudioCodecs;zd(a,g,h,e,f);k=t(a.variants);for(l=k.next();!l.done;l=k.next())m=l.value,d.push(be(m));n=t(a.textStreams);for(p=n.next();!p.done;p=n.next())q=p.value,
d.push(ce(q));v=t(a.imageStreams);for(y=v.next();!y.done;y=v.next())x=y.value,d.push(de(x));return u(ta,b.offline.trackSelectionCallback(d),3);case 3:w=ta.h;D=a.presentationTimeline.getDuration();B=0;A=t(w);for(G=A.next();!G.done;G=A.next())E=G.value,H=E.bandwidth*D/8,B+=H;C(ta,4);return u(ta,b.offline.downloadSizeCallback(B),6);case 6:J=ta.h;if(!J)throw new N(2,9,9014);va(ta,5);break;case 4:I=F(ta);if(I instanceof N)throw I;throw new N(2,9,9015);case 5:L=new Set;P=new Set;S=new Set;Y=t(w);for(G=
Y.next();!G.done;G=Y.next())ea=G.value,"variant"==ea.type&&L.add(ea.id),"text"==ea.type&&P.add(ea.id),"image"==ea.type&&S.add(ea.id);a.variants=a.variants.filter(function(Ca){return L.has(Ca.id)});a.textStreams=a.textStreams.filter(function(Ca){return P.has(Ca.id)});a.imageStreams=a.imageStreams.filter(function(Ca){return S.has(Ca.id)});Vs(a);z(ta)}})}
...
tilesLayout:d.tilesLayout},h=e.offline.numberOfParallelDownloads,k=0;it(d,c.presentationTimeline.Pa(),function(l){var m=wr(l),n=void 0;if(!f.has(m)){var p=l.endTime-l.startTime;p=Es(b,d.id)*p;p=zr(a.g,p);f.set(m,new vr(l,p,k,!1))}l.i&&(n=wr(l.i),f.has(n)||(p=.5*Es(b,d.id),p=zr(a.g,p),f.set(n,new vr(l.i,p,k,!0))));g.segments.push({pendingInitSegmentRefId:n,initSegmentKey:n?0:null,startTime:l.startTime,endTime:l.endTime,appendWindowStart:l.appendWindowStart,appendWindowEnd:l.appendWindowEnd,timestampOffset:l.timestampOffset,
...
function Ot(a,b){a.g.lb();if(!b)return Promise.resolve();a.g.C(b,"webkitneedkey",Pt);try{return Ei(b,HTMLMediaElement.HAVE_METADATA,a.g,function(){b.webkitSetMediaKeys(a.h)}),Promise.resolve()}catch(c){return Promise.reject(c)}}function Rt(a){We.call(this);this.i=null;this.l=a;this.g=this.h=null;this.j=new of;this.sessionId="";this.expiration=NaN;this.closed=new lc;this.keyStatuses=new St}pa(Rt,We);r=Rt.prototype;
...
function iu(a,b){var c=a.j.get(b);return c?c:(c=a.i.shift())?(c.sessionId=b,a.j.set(b,c),c):null}function ku(a,b,c){We.call(this);this.j=a;this.m=!1;this.g=this.h=null;this.i=b;this.l=c;this.sessionId="";this.expiration=NaN;this.closed=new lc;this.keyStatuses=new lu}pa(ku,We);r=ku.prototype;
...
function mu(a,b,c){if(a.m)return Promise.reject(Error("The session is already initialized."));a.m=!0;try{if("persistent-license"==a.l)if(c)var d=Fb(Ic("LOAD_SESSION|"+c));else{var e=Ic("PERSISTENT|");d=Qc(e,b)}else d=Fb(b)}catch(g){return Promise.reject(g)}a.h=new lc;var f=gu("generateKeyRequest");try{a.j[f](a.i,d)}catch(g){if("InvalidStateError"!=g.name)return a.h=null,Promise.reject(g);(new O(function(){try{a.j[f](a.i,d)}catch(h){a.h.reject(h),a.h=null}})).R(.01)}return a.h}
function nu(a,b,c){if(a.g)a.g.then(function(){return nu(a,b,c)})["catch"](function(){return nu(a,b,c)});else{a.g=b;if("webkit-org.w3.clearkey"==a.i){var d=Bc(c);var e=JSON.parse(d);"oct"!=e.keys[0].kty&&(a.g.reject(Error("Response is not a valid JSON Web Key Set.")),a.g=null);d=Nc(e.keys[0].k);e=Nc(e.keys[0].kid)}else d=Fb(c),e=null;var f=gu("addKey");try{a.j[f](a.i,d,e,a.sessionId)}catch(g){a.g.reject(g),a.g=null}}}
function ju(a,b){var c=a.keyStatuses;c.size=void 0==b?0:1;c.g=b;c=new R("keystatuseschange");a.dispatchEvent(c)}r.generateRequest=function(a,b){return mu(this,b,null)};r.load=function(a){return"persistent-license"==this.l?mu(this,null,a):Promise.reject(Error("Not a persistent session."))};r.update=function(a){var b=new lc;nu(this,b,a);return b};
...
p.next()){var v=q.value;q=new jb;var y=v.getAttribute("xml:id");if(y){q.id=y;var x=null;e&&(x=Uu.exec(e)||Vu.exec(e));y=x?Number(x[1]):null;x=x?Number(x[2]):null;var w,D;if(w=Wu(v,l,"extent"))w=(D=Uu.exec(w))||Vu.exec(w),null!=w&&(q.width=Number(w[1]),q.height=Number(w[2]),D||(null!=y&&(q.width=100*q.width/y),null!=x&&(q.height=100*q.height/x)),q.widthUnits=D||null!=y?Ab:0,q.heightUnits=D||null!=x?Ab:0);if(v=Wu(v,l,"origin"))w=(D=Uu.exec(v))||Vu.exec(v),null!=w&&(q.viewportAnchorX=Number(w[1]),q.viewportAnchorY=
...
function bv(a,b,c,d,e,f,g){f=f||g;"rtl"==cv(b,c,e,"direction",f)&&(a.direction="rtl");g=cv(b,c,e,"writingMode",f);"tb"==g||"tblr"==g?a.writingMode="vertical-lr":"tbrl"==g?a.writingMode="vertical-rl":"rltb"==g||"rl"==g?a.direction="rtl":g&&(a.direction=ib);(g=cv(b,c,e,"textAlign",!0))?(a.positionAlign=dv[g],a.lineAlign=ev[g],a.textAlign=ub[g.toUpperCase()]):a.textAlign=lb;if(g=cv(b,c,e,"displayAlign",!0))a.displayAlign=vb[g.toUpperCase()];if(g=cv(b,c,e,"color",f))a.color=g;if(g=cv(b,c,e,"backgroundColor",
...
var Uu=/^(\d{1,2}(?:\.\d+)?|100(?:\.0+)?)% (\d{1,2}(?:\.\d+)?|100(?:\.0+)?)%$/,gv=/^(\d{1,2}(?:\.\d+)?|100)%$/,fv=/^(\d+px|\d+em|\d*\.?\d+c)$/,Vu=/^(\d+)px (\d+)px$/,lv=/^(\d{2,}):(\d{2}):(\d{2}):(\d{2})\.?(\d+)?$/,mv=/^(?:(\d{2,}):)?(\d{2}):(\d{2})$/,ov=/^(?:(\d{2,}):)?(\d{2}):(\d{2}\.\d{2,})$/,pv=/^(\d*(?:\.\d*)?)f$/,qv=/^(\d*(?:\.\d*)?)t$/,rv=RegExp("^(?:(\\d*(?:\\.\\d*)?)h)?(?:(\\d*(?:\\.\\d*)?)m)?(?:(\\d*(?:\\.\\d*)?)s)?(?:(\\d*(?:\\.\\d*)?)ms)?$"),ev={left:ob,center:"center",right:"end",start:ob,
...
function xv(a,b,c){var d;if(d=/^align:(start|middle|center|end|left|right)$/.exec(b))b=d[1],"middle"==b?a.textAlign=lb:a.textAlign=ub[b.toUpperCase()];else if(d=/^vertical:(lr|rl)$/.exec(b))a.writingMode="lr"==d[1]?"vertical-lr":"vertical-rl";else if(d=/^size:([\d.]+)%$/.exec(b))a.size=Number(d[1]);else if(d=/^position:([\d.]+)%(?:,(line-left|line-right|center|start|end))?$/.exec(b))a.position=Number(d[1]),d[2]&&(b=d[2],a.positionAlign="line-left"==b||"start"==b?"line-left":"line-right"==b||"end"==
b?"line-right":"center");else if(d=/^region:(.*)$/.exec(b)){if(b=Cv(c,d[1]))a.region=b}else if(c=/^line:([\d.]+)%(?:,(start|end|center))?$/.exec(b))a.lineInterpretation=1,a.line=Number(c[1]),c[2]&&(a.lineAlign=wb[c[2].toUpperCase()]);else if(c=/^line:(-?\d+)(?:,(start|end|center))?$/.exec(b))a.lineInterpretation=nb,a.line=Number(c[1]),c[2]&&(a.lineAlign=wb[c[2].toUpperCase()])}function Cv(a,b){var c=a.filter(function(d){return d.id==b});return c.length?c[0]:null}
...
var Lv=/^\s*\[([^\]]+)\]\r?\n([\s\S]*)/,Mv=/^\s*([^:]+):\s*(.*)/,Nv=/\s*,\s*/,Rv=/^(\d+:)?(\d{1,2}):(\d{1,2}(?:[.]\d{1,3})?)?$/;dd["text/x-ssa"]=function(){return new Kv};function Sv(){}function Tv(a,b,c){function d(h){Ib(f).setUint32(g,h.byteLength,!0);g+=4;f.set(Fb(h),g);g+=h.byteLength}if(!c||!c.byteLength)throw new N(2,6,6015);var e;"string"==typeof b?e=Jc(b,!0):e=b;a=Ec(a);a=Jc(a,!0);var f=new Uint8Array(12+a.byteLength+e.byteLength+c.byteLength),g=0;d(a);d(e);d(c);return f}M("shaka.util.FairPlayUtils",Sv);
Sv.commonFairPlayResponse=function(a,b){if(2===a){try{var c=Bc(b.data)}catch(f){return}var d=!1;c=c.trim();"<ckc>"===c.substr(0,5)&&"</ckc>"===c.substr(-6)&&(c=c.slice(5,-6),d=!0);try{var e=JSON.parse(c);e.ckc&&(c=e.ckc,d=!0);e.CkcMessage&&(c=e.CkcMessage,d=!0);e.License&&(c=e.License,d=!0)}catch(f){}d&&(b.data=Gb(Nc(c)))}};Sv.conaxFairPlayRequest=function(a,b){2===a&&(b.headers["Content-Type"]="application/octet-stream")};Sv.ezdrmFairPlayRequest=function(a,b){2===a&&(b.headers["Content-Type"]="application/octet-stream")};
Sv.verimatrixFairPlayRequest=function(a,b){if(2===a){var c=Fb(b.body);c=Mc(c);b.headers["Content-Type"]="application/x-www-form-urlencoded";b.body=Ic("spc="+c)}};Sv.conaxInitDataTransform=function(a,b,c){if("skd"!==b)return a;b=c.serverCertificate;c=Ec(a).split("skd://").pop().split("?").shift();c=window.atob(c);var d=new ArrayBuffer(2*c.length);d=new Uint16Array(d);for(var e=0,f=c.length;e<f;e++)d[e]=c.charCodeAt(e);return Tv(a,d,b)};
Sv.ezdrmInitDataTransform=function(a,b,c){if("skd"!==b)return a;b=c.serverCertificate;c=Ec(a).split(";").pop();return Tv(a,c,b)};Sv.verimatrixInitDataTransform=function(a,b,c){if("skd"!==b)return a;b=c.serverCertificate;c=Ec(a).split("skd://").pop();return Tv(a,c,b)};Sv.initDataTransform=Tv;Sv.defaultGetContentId=function(a){a=Ec(a);return(new Nb(a)).Fa};
